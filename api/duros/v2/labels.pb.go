...
const file_lightbits_api_duros_v2_labels_proto_rawDesc = "" +
	"\n" +
	"#lightbits/api/duros/v2/labels.proto\x12\x16lightbits.api.duros.v2\"/\n" +
	"\x05Label\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05valueB\rZ\vduros/v2;v2b\x06proto3"

var (
	file_lightbits_api_duros_v2_labels_proto_rawDescOnce sync.Once
	file_lightbits_api_duros_v2_labels_proto_rawDescData []byte
)
...
func file_lightbits_api_duros_v2_labels_proto_rawDescGZIP() []byte {
	file_lightbits_api_duros_v2_labels_proto_rawDescOnce.Do(func() {
		file_lightbits_api_duros_v2_labels_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_lightbits_api_duros_v2_labels_proto_rawDesc), len(file_lightbits_api_duros_v2_labels_proto_rawDesc)))
	})
...
func file_lightbits_api_duros_v2_labels_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_lightbits_api_duros_v2_labels_proto_rawDesc), len(file_lightbits_api_duros_v2_labels_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
