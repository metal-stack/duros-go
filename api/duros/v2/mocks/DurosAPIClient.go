...
// NewDurosAPIClient creates a new instance of DurosAPIClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDurosAPIClient(t testing.TB) *DurosAPIClient {
	mock := &DurosAPIClient{}
	mock.Mock.Test(t)
