...
// NewDurosAPI_FetchLogsServer creates a new instance of DurosAPI_FetchLogsServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDurosAPI_FetchLogsServer(t testing.TB) *DurosAPI_FetchLogsServer {
