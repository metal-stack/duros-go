...
// newIsEvent_ComponentInfo creates a new instance of isEvent_ComponentInfo. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newIsEvent_ComponentInfo(t testing.TB) *isEvent_ComponentInfo {
