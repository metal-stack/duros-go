...
// NewDurosAPIServer creates a new instance of DurosAPIServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDurosAPIServer(t testing.TB) *DurosAPIServer {
	mock := &DurosAPIServer{}
	mock.Mock.Test(t)
