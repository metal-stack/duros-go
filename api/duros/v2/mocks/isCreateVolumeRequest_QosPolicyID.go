...
type mockConstructorTestingTnewIsCreateVolumeRequest_QosPolicyID interface {
	mock.TestingT
	Cleanup(func())
}
...
func newIsCreateVolumeRequest_QosPolicyID(t mockConstructorTestingTnewIsCreateVolumeRequest_QosPolicyID) *isCreateVolumeRequest_QosPolicyID {
