...
type DurosAPI_FetchLogsClient[Res interface{}] struct {
	mock.Mock
}

// CloseSend provides a mock function with no fields
func (_m *DurosAPI_FetchLogsClient[Res]) CloseSend() error {
	ret := _m.Called()
...
func (_m *DurosAPI_FetchLogsClient[Res]) Context() context.Context {
	ret := _m.Called()
...
func (_m *DurosAPI_FetchLogsClient[Res]) Header() (metadata.MD, error) {
	ret := _m.Called()
...
func (_m *DurosAPI_FetchLogsClient[Res]) Recv() (*httpbody.HttpBody, error) {
	ret := _m.Called()
...
func (_m *DurosAPI_FetchLogsClient[Res]) RecvMsg(m interface{}) error {
	ret := _m.Called(m)
...
func (_m *DurosAPI_FetchLogsClient[Res]) SendMsg(m interface{}) error {
	ret := _m.Called(m)
...
func (_m *DurosAPI_FetchLogsClient[Res]) Trailer() metadata.MD {
	ret := _m.Called()
...
func NewDurosAPI_FetchLogsClient[Res interface{}](t interface {
	mock.TestingT
	Cleanup(func())
}) *DurosAPI_FetchLogsClient[Res] {
	mock := &DurosAPI_FetchLogsClient[Res]{}
	mock.Mock.Test(t)
