...
// NewDurosAPI_FetchLogsClient creates a new instance of DurosAPI_FetchLogsClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDurosAPI_FetchLogsClient(t testing.TB) *DurosAPI_FetchLogsClient {
