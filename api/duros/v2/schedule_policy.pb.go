...
func file_lightbits_api_duros_v2_schedule_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_lightbits_api_duros_v2_schedule_policy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_lightbits_api_duros_v2_schedule_policy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_lightbits_api_duros_v2_schedule_policy_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_lightbits_api_duros_v2_schedule_policy_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_lightbits_api_duros_v2_schedule_policy_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_lightbits_api_duros_v2_schedule_policy_proto_msgTypes[5].Exporter = func(v any, i int) any {
