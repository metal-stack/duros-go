...
const file_lightbits_api_duros_v2_security_proto_rawDesc = "" +
	"\n" +
	"%lightbits/api/duros/v2/security.proto\x12\x16lightbits.api.duros.v2\x1a#lightbits/api/duros/v2/labels.proto\"\xa8\x01\n" +
	...
	"\x06labels\x18\x05 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\"\xa1\x01\n" +
	"\x18CreateTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\x12\x18\n" +
	"\ahostNqn\x18\x03 \x01(\tR\ahostNqn\x125\n" +
	"\x06labels\x18\x04 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\"P\n" +
	"\x18DeleteTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\"\x1b\n" +
	"\x19DeleteTrustedHostResponse\"M\n" +
	"\x15GetTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\"\xa1\x01\n" +
	"\x18UpdateTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\x12\x18\n" +
	"\ahostNqn\x18\x03 \x01(\tR\ahostNqn\x125\n" +
	"\x06labels\x18\x04 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\"\xa8\x01\n" +
	...
	"\n" +
	"hostSecret\x18\x03 \x01(\fR\n" +
	"hostSecret\x12\"\n" +
	"\ftargetSecret\x18\x04 \x01(\fR\ftargetSecret\x12T\n" +
	"\x10targetSecretType\x18\x05 \x01(\x0e2(.lightbits.api.duros.v2.TargetSecretTypeR\x10targetSecretType\"\x1f\n" +
	"\x1dSetTrustedHostSecretsResponse\"T\n" +
	"\x1cGetTrustedHostSecretsRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\"\xf2\x01\n" +
	"\x1dGetTrustedHostSecretsResponse\x127\n" +
	"\x04host\x18\x01 \x01(\v2#.lightbits.api.duros.v2.TrustedHostR\x04host\x12\x1e\n" +
	"\n" +
	"hostSecret\x18\x02 \x01(\fR\n" +
	"hostSecret\x12\"\n" +
	"\ftargetSecret\x18\x03 \x01(\fR\ftargetSecret\x12T\n" +
