...
const file_lightbits_api_duros_v2_security_proto_rawDesc = "" +
	"\n" +
	"%lightbits/api/duros/v2/security.proto\x12\x16lightbits.api.duros.v2\x1a#lightbits/api/duros/v2/labels.proto\x1a9grpc/gateway/protoc_gen_swagger/options/annotations.proto\"\xcc\x01\n" +
	"\vTrustedHost\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\x12\x12\n" +
	"\x04UUID\x18\x03 \x01(\tR\x04UUID\x12\x18\n" +
	"\ahostNqn\x18\x04 \x01(\tR\ahostNqn\x125\n" +
	"\x06labels\x18\x05 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\x12\"\n" +
	"\fauthRequired\x18\x06 \x01(\tR\fauthRequired\"\xeb\x01\n" +
	"\x18CreateTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\x12\x18\n" +
	"\ahostNqn\x18\x03 \x01(\tR\ahostNqn\x125\n" +
	"\x06labels\x18\x04 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\x12\"\n" +
	"\fauthRequired\x18\x05 \x01(\tR\fauthRequired:$\x92A!\n" +
	"\x1f\xd2\x01\x04name\xd2\x01\vprojectName\xd2\x01\ahostNqn\"l\n" +
	"\x18DeleteTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName:\x1a\x92A\x17\n" +
	"\x15\xd2\x01\x04name\xd2\x01\vprojectName\"\x1b\n" +
	"\x19DeleteTrustedHostResponse\"i\n" +
	"\x15GetTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName:\x1a\x92A\x17\n" +
	"\x15\xd2\x01\x04name\xd2\x01\vprojectName\"\xe1\x01\n" +
	"\x18UpdateTrustedHostRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\x12\x18\n" +
	"\ahostNqn\x18\x03 \x01(\tR\ahostNqn\x125\n" +
	"\x06labels\x18\x04 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\x12\"\n" +
	"\fauthRequired\x18\x05 \x01(\tR\fauthRequired:\x1a\x92A\x17\n" +
	"\x15\xd2\x01\x04name\xd2\x01\vprojectName\"\xa8\x01\n" +
	"\x17ListTrustedHostsRequest\x12 \n" +
	"\vprojectName\x18\x01 \x01(\tR\vprojectName\x125\n" +
	"\x06labels\x18\x02 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\x12\x1e\n" +
	"\n" +
	"offsetUUID\x18\x03 \x01(\tR\n" +
	"offsetUUID\x12\x14\n" +
	"\x05limit\x18\x04 \x01(\x03R\x05limit\"u\n" +
	"\x18ListTrustedHostsResponse\x129\n" +
	"\x05hosts\x18\x01 \x03(\v2#.lightbits.api.duros.v2.TrustedHostR\x05hosts\x12\x1e\n" +
	"\n" +
	"nextOffset\x18\x02 \x01(\tR\n" +
	"nextOffset\"\x97\x02\n" +
	"\x1cSetTrustedHostSecretsRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName\x12\x1e\n" +
	"\n" +
	"hostSecret\x18\x03 \x01(\tR\n" +
	"hostSecret\x12\"\n" +
	"\ftargetSecret\x18\x04 \x01(\tR\ftargetSecret\x12T\n" +
	"\x10targetSecretType\x18\x05 \x01(\x0e2(.lightbits.api.duros.v2.TargetSecretTypeR\x10targetSecretType:'\x92A$\n" +
	"\"\xd2\x01\x04name\xd2\x01\vprojectName\xd2\x01\n" +
	"hostSecret\"\x1f\n" +
	"\x1dSetTrustedHostSecretsResponse\"p\n" +
	"\x1cGetTrustedHostSecretsRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vprojectName\x18\x02 \x01(\tR\vprojectName:\x1a\x92A\x17\n" +
	"\x15\xd2\x01\x04name\xd2\x01\vprojectName\"\xf2\x01\n" +
	"\x1dGetTrustedHostSecretsResponse\x127\n" +
	"\x04host\x18\x01 \x01(\v2#.lightbits.api.duros.v2.TrustedHostR\x04host\x12\x1e\n" +
	"\n" +
	"hostSecret\x18\x02 \x01(\tR\n" +
	"hostSecret\x12\"\n" +
	"\ftargetSecret\x18\x03 \x01(\tR\ftargetSecret\x12T\n" +
	"\x10targetSecretType\x18\x04 \x01(\x0e2(.lightbits.api.duros.v2.TargetSecretTypeR\x10targetSecretType\"L\n" +
	"\x1eEnableClusterInBandAuthRequest\x12*\n" +
	"\x10subsystemNqnName\x18\x01 \x01(\tR\x10subsystemNqnName\"M\n" +
	"\x1fDisableClusterInBandAuthRequest\x12*\n" +
	"\x10subsystemNqnName\x18\x01 \x01(\tR\x10subsystemNqnName\"!\n" +
	"\x1fEnableClusterInBandAuthResponse\"\"\n" +
	" DisableClusterInBandAuthResponse*@\n" +
	"\x10TargetSecretType\x12\f\n" +
	"\bDisabled\x10\x00\x12\v\n" +
	"\aEnabled\x10\x01\x12\x11\n" +
	"\rAutoGenSecret\x10\x02B\rZ\vduros/v2;v2b\x06proto3"
