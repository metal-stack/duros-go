...
const file_lightbits_api_duros_v2_durosapiv2_proto_rawDesc = "" +
	...
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x125\n" +
	"\x06labels\x18\v \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels:\x13\x92A\x10\n" +
	...
	"\x06labels\x18\x19 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\"\x87\x01\n" +
	"\tStateEnum\x12\v\n" +
	...
	"\x1eFederatedAuthenticationEnabled\x10\x012\xe4\xa9\x03\n" +
	...
	"\x03403\x12\x1c\n" +
	"\x12Permission denied.\x12\x06\n" +
	"\x04\x9a\x02\x01\x03\x82\xd3\xe4\x93\x024:\x01*\"//api/v2/cluster/federatedAuthentication/disableB\rZ\vduros/v2;v2b\x06proto3"
...
var file_lightbits_api_duros_v2_durosapiv2_proto_goTypes = []any{
	...
	(*httpbody.HttpBody)(nil),                // 240: google.api.HttpBody
	(*EnableClusterInBandAuthResponse)(nil),  // 241: lightbits.api.duros.v2.EnableClusterInBandAuthResponse
	(*DisableClusterInBandAuthResponse)(nil), // 242: lightbits.api.duros.v2.DisableClusterInBandAuthResponse
	(*TrustedHost)(nil),                      // 243: lightbits.api.duros.v2.TrustedHost
	(*DeleteTrustedHostResponse)(nil),        // 244: lightbits.api.duros.v2.DeleteTrustedHostResponse
	(*ListTrustedHostsResponse)(nil),         // 245: lightbits.api.duros.v2.ListTrustedHostsResponse
	(*SetTrustedHostSecretsResponse)(nil),    // 246: lightbits.api.duros.v2.SetTrustedHostSecretsResponse
	(*GetTrustedHostSecretsResponse)(nil),    // 247: lightbits.api.duros.v2.GetTrustedHostSecretsResponse
}
var file_lightbits_api_duros_v2_durosapiv2_proto_depIdxs = []int32{
	...
	106, // 234: lightbits.api.duros.v2.DurosAPI.GetVersion:output_type -> lightbits.api.duros.v2.Version
	111, // 235: lightbits.api.duros.v2.DurosAPI.CreateVolume:output_type -> lightbits.api.duros.v2.Volume
	62,  // 236: lightbits.api.duros.v2.DurosAPI.DeleteVolume:output_type -> lightbits.api.duros.v2.DeleteVolumeResponse
	91,  // 237: lightbits.api.duros.v2.DurosAPI.ListVolumes:output_type -> lightbits.api.duros.v2.ListVolumesResponse
	80,  // 238: lightbits.api.duros.v2.DurosAPI.ListEvents:output_type -> lightbits.api.duros.v2.ListEventsResponse
	87,  // 239: lightbits.api.duros.v2.DurosAPI.GetHost:output_type -> lightbits.api.duros.v2.ConnectedHost
	77,  // 240: lightbits.api.duros.v2.DurosAPI.ListHosts:output_type -> lightbits.api.duros.v2.ListHostsResponse
	111, // 241: lightbits.api.duros.v2.DurosAPI.GetVolume:output_type -> lightbits.api.duros.v2.Volume
	90,  // 242: lightbits.api.duros.v2.DurosAPI.ListNodes:output_type -> lightbits.api.duros.v2.ListNodesResponse
	89,  // 243: lightbits.api.duros.v2.DurosAPI.GetNode:output_type -> lightbits.api.duros.v2.DurosNodeInfo
	86,  // 244: lightbits.api.duros.v2.DurosAPI.ListNvmeDevices:output_type -> lightbits.api.duros.v2.ListNvmeDevicesResponse
	88,  // 245: lightbits.api.duros.v2.DurosAPI.GetNvmeDevice:output_type -> lightbits.api.duros.v2.UserNvmeDevicesResponse
	240, // 246: lightbits.api.duros.v2.DurosAPI.FetchLogs:output_type -> google.api.HttpBody
	108, // 247: lightbits.api.duros.v2.DurosAPI.GetCluster:output_type -> lightbits.api.duros.v2.ClusterInfo
	109, // 248: lightbits.api.duros.v2.DurosAPI.GetClusterInfo:output_type -> lightbits.api.duros.v2.ClusterInfoV2
	92,  // 249: lightbits.api.duros.v2.DurosAPI.UpdateNvmeDevice:output_type -> lightbits.api.duros.v2.UpdateNvmeDeviceResponse
	93,  // 250: lightbits.api.duros.v2.DurosAPI.AddNvmeDevice:output_type -> lightbits.api.duros.v2.AddNvmeDeviceResponse
	94,  // 251: lightbits.api.duros.v2.DurosAPI.UpdateVolume:output_type -> lightbits.api.duros.v2.UpdateVolumeResponse
	114, // 252: lightbits.api.duros.v2.DurosAPI.GetServer:output_type -> lightbits.api.duros.v2.Server
	103, // 253: lightbits.api.duros.v2.DurosAPI.ListServers:output_type -> lightbits.api.duros.v2.ListServersResponse
	95,  // 254: lightbits.api.duros.v2.DurosAPI.UpgradeServer:output_type -> lightbits.api.duros.v2.UpgradeServerResponse
	96,  // 255: lightbits.api.duros.v2.DurosAPI.UpgradeCluster:output_type -> lightbits.api.duros.v2.UpgradeClusterResponse
	97,  // 256: lightbits.api.duros.v2.DurosAPI.EnableClusterEncryption:output_type -> lightbits.api.duros.v2.EnableClusterEncryptionResponse
	114, // 257: lightbits.api.duros.v2.DurosAPI.CreateServer:output_type -> lightbits.api.duros.v2.Server
	98,  // 258: lightbits.api.duros.v2.DurosAPI.ReplaceNode:output_type -> lightbits.api.duros.v2.ReplaceNodeResponse
	99,  // 259: lightbits.api.duros.v2.DurosAPI.DeleteServer:output_type -> lightbits.api.duros.v2.DeleteServerResponse
	114, // 260: lightbits.api.duros.v2.DurosAPI.EnableServer:output_type -> lightbits.api.duros.v2.Server
	100, // 261: lightbits.api.duros.v2.DurosAPI.DisableServer:output_type -> lightbits.api.duros.v2.DisableServerResponse
	52,  // 262: lightbits.api.duros.v2.DurosAPI.CreateProject:output_type -> lightbits.api.duros.v2.Project
	177, // 263: lightbits.api.duros.v2.DurosAPI.UpdateProject:output_type -> lightbits.api.duros.v2.UpdateProjectResponse
	54,  // 264: lightbits.api.duros.v2.DurosAPI.DeleteProject:output_type -> lightbits.api.duros.v2.DeleteProjectResponse
	56,  // 265: lightbits.api.duros.v2.DurosAPI.ListProjects:output_type -> lightbits.api.duros.v2.ListProjectsResponse
	52,  // 266: lightbits.api.duros.v2.DurosAPI.GetProject:output_type -> lightbits.api.duros.v2.Project
	44,  // 267: lightbits.api.duros.v2.DurosAPI.CreateCredential:output_type -> lightbits.api.duros.v2.Credential
	46,  // 268: lightbits.api.duros.v2.DurosAPI.DeleteCredential:output_type -> lightbits.api.duros.v2.DeleteCredentialResponse
	48,  // 269: lightbits.api.duros.v2.DurosAPI.ListCredentials:output_type -> lightbits.api.duros.v2.ListCredentialsResponse
	44,  // 270: lightbits.api.duros.v2.DurosAPI.GetCredential:output_type -> lightbits.api.duros.v2.Credential
	116, // 271: lightbits.api.duros.v2.DurosAPI.GetRole:output_type -> lightbits.api.duros.v2.GetRoleResponse
	119, // 272: lightbits.api.duros.v2.DurosAPI.ListRoles:output_type -> lightbits.api.duros.v2.ListRolesResponse
	35,  // 273: lightbits.api.duros.v2.DurosAPI.CreateAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	42,  // 274: lightbits.api.duros.v2.DurosAPI.DeleteAdminEndpoint:output_type -> lightbits.api.duros.v2.DeleteAdminEndpointResponse
	37,  // 275: lightbits.api.duros.v2.DurosAPI.ListAdminEndpoints:output_type -> lightbits.api.duros.v2.ListAdminEndpointsResponse
	35,  // 276: lightbits.api.duros.v2.DurosAPI.UpdateAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	35,  // 277: lightbits.api.duros.v2.DurosAPI.GetAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	138, // 278: lightbits.api.duros.v2.DurosAPI.CreateResourcePolicy:output_type -> lightbits.api.duros.v2.ResourcePolicy
	139, // 279: lightbits.api.duros.v2.DurosAPI.CreatePolicy:output_type -> lightbits.api.duros.v2.Policy
	137, // 280: lightbits.api.duros.v2.DurosAPI.UpdatePolicy:output_type -> lightbits.api.duros.v2.UpdatePolicyResponse
	141, // 281: lightbits.api.duros.v2.DurosAPI.UpdateResourcePolicy:output_type -> lightbits.api.duros.v2.UpdateResourcePolicyResponse
	139, // 282: lightbits.api.duros.v2.DurosAPI.GetPolicy:output_type -> lightbits.api.duros.v2.Policy
	143, // 283: lightbits.api.duros.v2.DurosAPI.ListPolicies:output_type -> lightbits.api.duros.v2.ListPoliciesResponse
	145, // 284: lightbits.api.duros.v2.DurosAPI.ListResourcePolicies:output_type -> lightbits.api.duros.v2.ListResourcePoliciesResponse
	138, // 285: lightbits.api.duros.v2.DurosAPI.GetResourcePolicy:output_type -> lightbits.api.duros.v2.ResourcePolicy
	149, // 286: lightbits.api.duros.v2.DurosAPI.DeleteResourcePolicy:output_type -> lightbits.api.duros.v2.DeleteResourcePolicyResponse
	151, // 287: lightbits.api.duros.v2.DurosAPI.DeletePolicy:output_type -> lightbits.api.duros.v2.DeletePolicyResponse
	120, // 288: lightbits.api.duros.v2.DurosAPI.CreateSnapshot:output_type -> lightbits.api.duros.v2.Snapshot
	120, // 289: lightbits.api.duros.v2.DurosAPI.GetSnapshot:output_type -> lightbits.api.duros.v2.Snapshot
	125, // 290: lightbits.api.duros.v2.DurosAPI.ListSnapshots:output_type -> lightbits.api.duros.v2.ListSnapshotsResponse
	126, // 291: lightbits.api.duros.v2.DurosAPI.DeleteSnapshot:output_type -> lightbits.api.duros.v2.DeleteSnapshotResponse
	127, // 292: lightbits.api.duros.v2.DurosAPI.GetFeatureFlag:output_type -> lightbits.api.duros.v2.FeatureFlagStatus
	131, // 293: lightbits.api.duros.v2.DurosAPI.EnableFeatureFlag:output_type -> lightbits.api.duros.v2.SetFeatureFlagResponse
	131, // 294: lightbits.api.duros.v2.DurosAPI.DisableFeatureFlag:output_type -> lightbits.api.duros.v2.SetFeatureFlagResponse
	133, // 295: lightbits.api.duros.v2.DurosAPI.ListFeatureFlags:output_type -> lightbits.api.duros.v2.ListFeatureFlagsResponse
	153, // 296: lightbits.api.duros.v2.DurosAPI.GetClusterConfigParam:output_type -> lightbits.api.duros.v2.ClusterConfigParam
	157, // 297: lightbits.api.duros.v2.DurosAPI.UpdateClusterConfigParam:output_type -> lightbits.api.duros.v2.UpdateClusterConfigParamResponse
	159, // 298: lightbits.api.duros.v2.DurosAPI.ListClusterConfigParams:output_type -> lightbits.api.duros.v2.ListClusterConfigParamsResponse
	156, // 299: lightbits.api.duros.v2.DurosAPI.RollbackVolume:output_type -> lightbits.api.duros.v2.RollbackVolumeResponse
	172, // 300: lightbits.api.duros.v2.DurosAPI.ListChangedBlocks:output_type -> lightbits.api.duros.v2.ListChangedBlocksResponse
	182, // 301: lightbits.api.duros.v2.DurosAPI.RotateClusterRootKey:output_type -> lightbits.api.duros.v2.RotateClusterRootKeyResponse
	184, // 302: lightbits.api.duros.v2.DurosAPI.GetClusterRootKey:output_type -> lightbits.api.duros.v2.GetClusterRootKeyResponse
	185, // 303: lightbits.api.duros.v2.DurosAPI.CreateIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	192, // 304: lightbits.api.duros.v2.DurosAPI.DeleteIdpConfiguration:output_type -> lightbits.api.duros.v2.DeleteIDPConfigurationResponse
	185, // 305: lightbits.api.duros.v2.DurosAPI.UpdateIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	189, // 306: lightbits.api.duros.v2.DurosAPI.ListIdpConfigurations:output_type -> lightbits.api.duros.v2.ListIDPConfigurationsResponse
	185, // 307: lightbits.api.duros.v2.DurosAPI.GetIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	193, // 308: lightbits.api.duros.v2.DurosAPI.CreateIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	198, // 309: lightbits.api.duros.v2.DurosAPI.DeleteIdpClientConf:output_type -> lightbits.api.duros.v2.DeleteIdpClientConfResponse
	193, // 310: lightbits.api.duros.v2.DurosAPI.UpdateIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	200, // 311: lightbits.api.duros.v2.DurosAPI.ListIdpClientConfs:output_type -> lightbits.api.duros.v2.ListIdpClientConfsResponse
	193, // 312: lightbits.api.duros.v2.DurosAPI.GetIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	201, // 313: lightbits.api.duros.v2.DurosAPI.CreateAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	201, // 314: lightbits.api.duros.v2.DurosAPI.UpdateAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	207, // 315: lightbits.api.duros.v2.DurosAPI.DeleteAuthMapEntry:output_type -> lightbits.api.duros.v2.DeleteAuthMapEntryResponse
	201, // 316: lightbits.api.duros.v2.DurosAPI.GetAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	208, // 317: lightbits.api.duros.v2.DurosAPI.ListAuthMapEntries:output_type -> lightbits.api.duros.v2.ListAuthMapEntriesResponse
	241, // 318: lightbits.api.duros.v2.DurosAPI.EnableClusterInBandAuth:output_type -> lightbits.api.duros.v2.EnableClusterInBandAuthResponse
	242, // 319: lightbits.api.duros.v2.DurosAPI.DisableClusterInBandAuth:output_type -> lightbits.api.duros.v2.DisableClusterInBandAuthResponse
	243, // 320: lightbits.api.duros.v2.DurosAPI.CreateTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	244, // 321: lightbits.api.duros.v2.DurosAPI.DeleteTrustedHost:output_type -> lightbits.api.duros.v2.DeleteTrustedHostResponse
	243, // 322: lightbits.api.duros.v2.DurosAPI.GetTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	245, // 323: lightbits.api.duros.v2.DurosAPI.ListTrustedHosts:output_type -> lightbits.api.duros.v2.ListTrustedHostsResponse
	243, // 324: lightbits.api.duros.v2.DurosAPI.UpdateTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	246, // 325: lightbits.api.duros.v2.DurosAPI.SetTrustedHostSecret:output_type -> lightbits.api.duros.v2.SetTrustedHostSecretsResponse
	247, // 326: lightbits.api.duros.v2.DurosAPI.GetTrustedHostSecret:output_type -> lightbits.api.duros.v2.GetTrustedHostSecretsResponse
	210, // 327: lightbits.api.duros.v2.DurosAPI.EnableFederatedAuthentication:output_type -> lightbits.api.duros.v2.EnableFederatedAuthenticationResponse
	212, // 328: lightbits.api.duros.v2.DurosAPI.DisableFederatedAuthentication:output_type -> lightbits.api.duros.v2.DisableFederatedAuthenticationResponse
	234, // [234:329] is the sub-list for method output_type
	139, // [139:234] is the sub-list for method input_type
