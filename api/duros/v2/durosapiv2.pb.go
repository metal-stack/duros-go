...
const (
	...
	ClusterEncryptionStatus_EncryptyingDEKs ClusterEncryptionStatus_RotationState = 2 // Encrypting all DEKs with the new KEK
)
...
func (ClusterEncryptionStatus_RotationState) EnumDescriptor() ([]byte, []int) {
	return file_lightbits_api_duros_v2_durosapiv2_proto_rawDescGZIP(), []int{144, 1}
}
...
const file_lightbits_api_duros_v2_durosapiv2_proto_rawDesc = "" +
	...
	"\ashowAll\x18\b \x01(\bR\ashowAll\"T\n" +
	...
	"\vvolumeUUIDs\x18\x04 \x03(\tR\vvolumeUUIDs\"\xdd\x04\n" +
	...
	"\x10permanentFailure\x18\x14 \x01(\bR\x10permanentFailure\"l\n" +
	"\x05State\x12\v\n" +
	...
	"\x15DisableServerResponse\"\xa0\x01\n" +
	...
	"\x10encryptionStatus\x18\x10 \x01(\v2/.lightbits.api.duros.v2.ClusterEncryptionStatusR\x10encryptionStatus\"\xf7\x02\n" +
	"\rClusterHealth\x12A\n" +
	...
	"\tclusterId\x18\x1a \x01(\tR\tclusterId\"\x87\x01\n" +
	"\tStateEnum\x12\v\n" +
	...
	"\x05roles\x18\x01 \x03(\v2\x1c.lightbits.api.duros.v2.RoleR\x05roles\"\xcd\a\n" +
	"\bSnapshot\x12@\n" +
	...
	"\x06labels\x18\x16 \x03(\v2\x1d.lightbits.api.duros.v2.LabelR\x06labels\"\\\n" +
	"\tStateEnum\x12\v\n" +
	"\aUnknown\x10\x00\x12\f\n" +
	"\bCreating\x10\x01\x12\r\n" +
	"\tAvailable\x10\x02\x12\f\n" +
	...
	"\x06values\x18\x01 \x03(\v2*.lightbits.api.duros.v2.ClusterConfigParamR\x06values\"\x95\x01\n" +
	...
	"\x15UpdateProjectResponse\"\x89\x04\n" +
	...
	"\x0fDistributingKEK\x10\x01\x12\x13\n" +
	"\x0fEncryptyingDEKs\x10\x02\"\xec\x01\n" +
	...
	"\x1eFederatedAuthenticationEnabled\x10\x012\x93\xc4\x03\n" +
	...
	"\x03500\x12#\n" +
	"\x19Internal Lightbits error.\x12\x06\n" +
	"\x04\x9a\x02\x01\x03\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/api/v2/servers/{UUID}/disable\x12\xce\x04\n" +
	...
	"\x03403\x12\x1c\n" +
	"\x12Permission denied.\x12\x06\n" +
	"\x04\x9a\x02\x01\x03\x82\xd3\xe4\x93\x024:\x01*\"//api/v2/cluster/federatedAuthentication/disable\x12\xd3\x03\n" +
	"\aCFLogin\x12&.lightbits.api.duros.v2.CFLoginRequest\x1a'.lightbits.api.duros.v2.CFLoginResponse\"\xf6\x02\x92A\xe2\x02\n" +
	...
	"\r\n" +
	"\tBasicAuth\x12\x00\x82\xd3\xe4\x93\x02\n" +
	"\"\b/cflogin\x12\x8c\x03\n" +
...
var file_lightbits_api_duros_v2_durosapiv2_proto_enumTypes = make([]protoimpl.EnumInfo, 34)
...
var file_lightbits_api_duros_v2_durosapiv2_proto_goTypes = []any{
	...
	(ClusterEncryptionStatus_RotationState)(0),       // 32: lightbits.api.duros.v2.ClusterEncryptionStatus.RotationState
	(IDPConfiguration_IDPConfigurationState)(0),      // 33: lightbits.api.duros.v2.IDPConfiguration.IDPConfigurationState
	(*LogRequest)(nil),                               // 34: lightbits.api.duros.v2.LogRequest
	(*AdminEndpoint)(nil),                            // 35: lightbits.api.duros.v2.AdminEndpoint
	(*GetAdminEndpointRequest)(nil),                  // 36: lightbits.api.duros.v2.GetAdminEndpointRequest
	(*ListAdminEndpointsResponse)(nil),               // 37: lightbits.api.duros.v2.ListAdminEndpointsResponse
	(*ListAdminEndpointsRequest)(nil),                // 38: lightbits.api.duros.v2.ListAdminEndpointsRequest
	(*CreateAdminEndpointRequest)(nil),               // 39: lightbits.api.duros.v2.CreateAdminEndpointRequest
	(*UpdateAdminEndpointRequest)(nil),               // 40: lightbits.api.duros.v2.UpdateAdminEndpointRequest
	(*DeleteAdminEndpointRequest)(nil),               // 41: lightbits.api.duros.v2.DeleteAdminEndpointRequest
	(*DeleteAdminEndpointResponse)(nil),              // 42: lightbits.api.duros.v2.DeleteAdminEndpointResponse
	(*CreateCredentialRequest)(nil),                  // 43: lightbits.api.duros.v2.CreateCredentialRequest
	(*Credential)(nil),                               // 44: lightbits.api.duros.v2.Credential
	(*DeleteCredentialRequest)(nil),                  // 45: lightbits.api.duros.v2.DeleteCredentialRequest
	(*DeleteCredentialResponse)(nil),                 // 46: lightbits.api.duros.v2.DeleteCredentialResponse
	(*ListCredentialsRequest)(nil),                   // 47: lightbits.api.duros.v2.ListCredentialsRequest
	(*ListCredentialsResponse)(nil),                  // 48: lightbits.api.duros.v2.ListCredentialsResponse
	(*GetCredentialRequest)(nil),                     // 49: lightbits.api.duros.v2.GetCredentialRequest
	(*DefaultPolicy)(nil),                            // 50: lightbits.api.duros.v2.DefaultPolicy
	(*CreateProjectRequest)(nil),                     // 51: lightbits.api.duros.v2.CreateProjectRequest
	(*Project)(nil),                                  // 52: lightbits.api.duros.v2.Project
	(*DeleteProjectRequest)(nil),                     // 53: lightbits.api.duros.v2.DeleteProjectRequest
	(*DeleteProjectResponse)(nil),                    // 54: lightbits.api.duros.v2.DeleteProjectResponse
	(*ListProjectsRequest)(nil),                      // 55: lightbits.api.duros.v2.ListProjectsRequest
	(*ListProjectsResponse)(nil),                     // 56: lightbits.api.duros.v2.ListProjectsResponse
	(*GetProjectRequest)(nil),                        // 57: lightbits.api.duros.v2.GetProjectRequest
	(*StringList)(nil),                               // 58: lightbits.api.duros.v2.StringList
	(*GetVersionRequest)(nil),                        // 59: lightbits.api.duros.v2.GetVersionRequest
	(*CreateVolumeRequest)(nil),                      // 60: lightbits.api.duros.v2.CreateVolumeRequest
	(*DeleteVolumeRequest)(nil),                      // 61: lightbits.api.duros.v2.DeleteVolumeRequest
	(*DeleteVolumeResponse)(nil),                     // 62: lightbits.api.duros.v2.DeleteVolumeResponse
	(*EnableServerRequest)(nil),                      // 63: lightbits.api.duros.v2.EnableServerRequest
	(*DisableServerRequest)(nil),                     // 64: lightbits.api.duros.v2.DisableServerRequest
	(*DeleteServerRequest)(nil),                      // 65: lightbits.api.duros.v2.DeleteServerRequest
	(*ReplaceNodeRequest)(nil),                       // 66: lightbits.api.duros.v2.ReplaceNodeRequest
	(*CreateServerRequest)(nil),                      // 67: lightbits.api.duros.v2.CreateServerRequest
	(*UpdateVolumeRequest)(nil),                      // 68: lightbits.api.duros.v2.UpdateVolumeRequest
	(*UpgradeServerRequest)(nil),                     // 69: lightbits.api.duros.v2.UpgradeServerRequest
	(*UpgradeClusterRequest)(nil),                    // 70: lightbits.api.duros.v2.UpgradeClusterRequest
	(*EnableClusterEncryptionRequest)(nil),           // 71: lightbits.api.duros.v2.EnableClusterEncryptionRequest
	(*GetClusterRequest)(nil),                        // 72: lightbits.api.duros.v2.GetClusterRequest
	(*UpdateNvmeDeviceRequest)(nil),                  // 73: lightbits.api.duros.v2.UpdateNvmeDeviceRequest
	(*AddNvmeDeviceRequest)(nil),                     // 74: lightbits.api.duros.v2.AddNvmeDeviceRequest
	(*GetHostRequest)(nil),                           // 75: lightbits.api.duros.v2.GetHostRequest
	(*ListHostsRequest)(nil),                         // 76: lightbits.api.duros.v2.ListHostsRequest
	(*ListHostsResponse)(nil),                        // 77: lightbits.api.duros.v2.ListHostsResponse
	(*ListNodeRequest)(nil),                          // 78: lightbits.api.duros.v2.ListNodeRequest
	(*ListEventsRequest)(nil),                        // 79: lightbits.api.duros.v2.ListEventsRequest
	(*ListEventsResponse)(nil),                       // 80: lightbits.api.duros.v2.ListEventsResponse
	(*GetVolumeRequest)(nil),                         // 81: lightbits.api.duros.v2.GetVolumeRequest
	(*GetNodeRequest)(nil),                           // 82: lightbits.api.duros.v2.GetNodeRequest
	(*ListVolumeRequest)(nil),                        // 83: lightbits.api.duros.v2.ListVolumeRequest
	(*ListNvmeDevicesRequest)(nil),                   // 84: lightbits.api.duros.v2.ListNvmeDevicesRequest
	(*GetNvmeDeviceRequest)(nil),                     // 85: lightbits.api.duros.v2.GetNvmeDeviceRequest
	(*ListNvmeDevicesResponse)(nil),                  // 86: lightbits.api.duros.v2.ListNvmeDevicesResponse
	(*ConnectedHost)(nil),                            // 87: lightbits.api.duros.v2.ConnectedHost
	(*UserNvmeDevicesResponse)(nil),                  // 88: lightbits.api.duros.v2.UserNvmeDevicesResponse
	(*DurosNodeInfo)(nil),                            // 89: lightbits.api.duros.v2.DurosNodeInfo
	(*ListNodesResponse)(nil),                        // 90: lightbits.api.duros.v2.ListNodesResponse
	(*ListVolumesResponse)(nil),                      // 91: lightbits.api.duros.v2.ListVolumesResponse
	(*UpdateNvmeDeviceResponse)(nil),                 // 92: lightbits.api.duros.v2.UpdateNvmeDeviceResponse
	(*AddNvmeDeviceResponse)(nil),                    // 93: lightbits.api.duros.v2.AddNvmeDeviceResponse
	(*UpdateVolumeResponse)(nil),                     // 94: lightbits.api.duros.v2.UpdateVolumeResponse
	(*UpgradeServerResponse)(nil),                    // 95: lightbits.api.duros.v2.UpgradeServerResponse
	(*UpgradeClusterResponse)(nil),                   // 96: lightbits.api.duros.v2.UpgradeClusterResponse
	(*EnableClusterEncryptionResponse)(nil),          // 97: lightbits.api.duros.v2.EnableClusterEncryptionResponse
	(*ReplaceNodeResponse)(nil),                      // 98: lightbits.api.duros.v2.ReplaceNodeResponse
	(*DeleteServerResponse)(nil),                     // 99: lightbits.api.duros.v2.DeleteServerResponse
	(*DisableServerResponse)(nil),                    // 100: lightbits.api.duros.v2.DisableServerResponse
	(*ListServersRequest)(nil),                       // 101: lightbits.api.duros.v2.ListServersRequest
	(*GetServerRequest)(nil),                         // 102: lightbits.api.duros.v2.GetServerRequest
	(*ListServersResponse)(nil),                      // 103: lightbits.api.duros.v2.ListServersResponse
	(*ClusterUpgradeStatusResponse)(nil),             // 104: lightbits.api.duros.v2.ClusterUpgradeStatusResponse
	(*ListUpgradeStatusResponse)(nil),                // 105: lightbits.api.duros.v2.ListUpgradeStatusResponse
	(*Version)(nil),                                  // 106: lightbits.api.duros.v2.Version
	(*ClusterLastUpgrade)(nil),                       // 107: lightbits.api.duros.v2.ClusterLastUpgrade
	(*ClusterInfo)(nil),                              // 108: lightbits.api.duros.v2.ClusterInfo
	(*ClusterInfoV2)(nil),                            // 109: lightbits.api.duros.v2.ClusterInfoV2
	(*ClusterHealth)(nil),                            // 110: lightbits.api.duros.v2.ClusterHealth
	(*Volume)(nil),                                   // 111: lightbits.api.duros.v2.Volume
	(*ServerEvictionStatus)(nil),                     // 112: lightbits.api.duros.v2.ServerEvictionStatus
	(*ServerLastUpgrade)(nil),                        // 113: lightbits.api.duros.v2.ServerLastUpgrade
	(*Server)(nil),                                   // 114: lightbits.api.duros.v2.Server
	(*GetRoleRequest)(nil),                           // 115: lightbits.api.duros.v2.GetRoleRequest
	(*GetRoleResponse)(nil),                          // 116: lightbits.api.duros.v2.GetRoleResponse
	(*Role)(nil),                                     // 117: lightbits.api.duros.v2.Role
	(*ListRolesRequest)(nil),                         // 118: lightbits.api.duros.v2.ListRolesRequest
	(*ListRolesResponse)(nil),                        // 119: lightbits.api.duros.v2.ListRolesResponse
	(*Snapshot)(nil),                                 // 120: lightbits.api.duros.v2.Snapshot
	(*DeleteSnapshotRequest)(nil),                    // 121: lightbits.api.duros.v2.DeleteSnapshotRequest
	(*CreateSnapshotRequest)(nil),                    // 122: lightbits.api.duros.v2.CreateSnapshotRequest
	(*ListSnapshotsRequest)(nil),                     // 123: lightbits.api.duros.v2.ListSnapshotsRequest
	(*GetSnapshotRequest)(nil),                       // 124: lightbits.api.duros.v2.GetSnapshotRequest
	(*ListSnapshotsResponse)(nil),                    // 125: lightbits.api.duros.v2.ListSnapshotsResponse
	(*DeleteSnapshotResponse)(nil),                   // 126: lightbits.api.duros.v2.DeleteSnapshotResponse
	(*FeatureFlagStatus)(nil),                        // 127: lightbits.api.duros.v2.FeatureFlagStatus
	(*GetFeatureFlagRequest)(nil),                    // 128: lightbits.api.duros.v2.GetFeatureFlagRequest
	(*EnableFeatureFlagRequest)(nil),                 // 129: lightbits.api.duros.v2.EnableFeatureFlagRequest
	(*DisableFeatureFlagRequest)(nil),                // 130: lightbits.api.duros.v2.DisableFeatureFlagRequest
	(*SetFeatureFlagResponse)(nil),                   // 131: lightbits.api.duros.v2.SetFeatureFlagResponse
	(*ListFeatureFlagsRequest)(nil),                  // 132: lightbits.api.duros.v2.ListFeatureFlagsRequest
	(*ListFeatureFlagsResponse)(nil),                 // 133: lightbits.api.duros.v2.ListFeatureFlagsResponse
	(*CreateResourcePolicyRequest)(nil),              // 134: lightbits.api.duros.v2.CreateResourcePolicyRequest
	(*CreatePolicyRequest)(nil),                      // 135: lightbits.api.duros.v2.CreatePolicyRequest
	(*UpdatePolicyRequest)(nil),                      // 136: lightbits.api.duros.v2.UpdatePolicyRequest
	(*UpdatePolicyResponse)(nil),                     // 137: lightbits.api.duros.v2.UpdatePolicyResponse
	(*ResourcePolicy)(nil),                           // 138: lightbits.api.duros.v2.ResourcePolicy
	(*Policy)(nil),                                   // 139: lightbits.api.duros.v2.Policy
	(*UpdateResourcePolicyRequest)(nil),              // 140: lightbits.api.duros.v2.UpdateResourcePolicyRequest
	(*UpdateResourcePolicyResponse)(nil),             // 141: lightbits.api.duros.v2.UpdateResourcePolicyResponse
	(*ListPoliciesRequest)(nil),                      // 142: lightbits.api.duros.v2.ListPoliciesRequest
	(*ListPoliciesResponse)(nil),                     // 143: lightbits.api.duros.v2.ListPoliciesResponse
	(*ListResourcePoliciesRequest)(nil),              // 144: lightbits.api.duros.v2.ListResourcePoliciesRequest
	(*ListResourcePoliciesResponse)(nil),             // 145: lightbits.api.duros.v2.ListResourcePoliciesResponse
	(*GetPolicyRequest)(nil),                         // 146: lightbits.api.duros.v2.GetPolicyRequest
	(*GetResourcePolicyRequest)(nil),                 // 147: lightbits.api.duros.v2.GetResourcePolicyRequest
	(*DeleteResourcePolicyRequest)(nil),              // 148: lightbits.api.duros.v2.DeleteResourcePolicyRequest
	(*DeleteResourcePolicyResponse)(nil),             // 149: lightbits.api.duros.v2.DeleteResourcePolicyResponse
	(*DeletePolicyRequest)(nil),                      // 150: lightbits.api.duros.v2.DeletePolicyRequest
	(*DeletePolicyResponse)(nil),                     // 151: lightbits.api.duros.v2.DeletePolicyResponse
	(*GetClusterConfigParamRequest)(nil),             // 152: lightbits.api.duros.v2.GetClusterConfigParamRequest
	(*ClusterConfigParam)(nil),                       // 153: lightbits.api.duros.v2.ClusterConfigParam
	(*UpdateClusterConfigParamRequest)(nil),          // 154: lightbits.api.duros.v2.UpdateClusterConfigParamRequest
	(*RollbackVolumeRequest)(nil),                    // 155: lightbits.api.duros.v2.RollbackVolumeRequest
	(*RollbackVolumeResponse)(nil),                   // 156: lightbits.api.duros.v2.RollbackVolumeResponse
	(*UpdateClusterConfigParamResponse)(nil),         // 157: lightbits.api.duros.v2.UpdateClusterConfigParamResponse
	(*ListClusterConfigParamsRequest)(nil),           // 158: lightbits.api.duros.v2.ListClusterConfigParamsRequest
	(*ListClusterConfigParamsResponse)(nil),          // 159: lightbits.api.duros.v2.ListClusterConfigParamsResponse
	(*LabelValueKeyPair)(nil),                        // 160: lightbits.api.duros.v2.LabelValueKeyPair
	(*LabelMatchExpression)(nil),                     // 161: lightbits.api.duros.v2.LabelMatchExpression
	(*ComponentVolumeInfo)(nil),                      // 162: lightbits.api.duros.v2.ComponentVolumeInfo
	(*VolumeComponentInfoList)(nil),                  // 163: lightbits.api.duros.v2.VolumeComponentInfoList
	(*ComponentVolumesInfo)(nil),                     // 164: lightbits.api.duros.v2.ComponentVolumesInfo
	(*ComponentNodeInfo)(nil),                        // 165: lightbits.api.duros.v2.ComponentNodeInfo
	(*ComponentClusterInfo)(nil),                     // 166: lightbits.api.duros.v2.ComponentClusterInfo
	(*ComponentNVMeSSDInfo)(nil),                     // 167: lightbits.api.duros.v2.ComponentNVMeSSDInfo
	(*ComponentServerInfo)(nil),                      // 168: lightbits.api.duros.v2.ComponentServerInfo
	(*ComponentDataIntegrityInfo)(nil),               // 169: lightbits.api.duros.v2.ComponentDataIntegrityInfo
	(*LBARange)(nil),                                 // 170: lightbits.api.duros.v2.LBARange
	(*ListChangedBlocksRequest)(nil),                 // 171: lightbits.api.duros.v2.ListChangedBlocksRequest
	(*ListChangedBlocksResponse)(nil),                // 172: lightbits.api.duros.v2.ListChangedBlocksResponse
	(*Event)(nil),                                    // 173: lightbits.api.duros.v2.Event
	(*QoSRateLimitPolicy)(nil),                       // 174: lightbits.api.duros.v2.QoSRateLimitPolicy
	(*DefaultGlobalResourcePolicy)(nil),              // 175: lightbits.api.duros.v2.DefaultGlobalResourcePolicy
	(*UpdateProjectRequest)(nil),                     // 176: lightbits.api.duros.v2.UpdateProjectRequest
	(*UpdateProjectResponse)(nil),                    // 177: lightbits.api.duros.v2.UpdateProjectResponse
	(*ClusterEncryptionStatus)(nil),                  // 178: lightbits.api.duros.v2.ClusterEncryptionStatus
	(*IdpHealthInfo)(nil),                            // 179: lightbits.api.duros.v2.IdpHealthInfo
	(*FederatedAuthenticationStatus)(nil),            // 180: lightbits.api.duros.v2.FederatedAuthenticationStatus
	(*RotateClusterRootKeyRequest)(nil),              // 181: lightbits.api.duros.v2.RotateClusterRootKeyRequest
	(*RotateClusterRootKeyResponse)(nil),             // 182: lightbits.api.duros.v2.RotateClusterRootKeyResponse
	(*GetClusterRootKeyRequest)(nil),                 // 183: lightbits.api.duros.v2.GetClusterRootKeyRequest
	(*GetClusterRootKeyResponse)(nil),                // 184: lightbits.api.duros.v2.GetClusterRootKeyResponse
	(*IDPConfiguration)(nil),                         // 185: lightbits.api.duros.v2.IDPConfiguration
	(*CreateIDPConfigurationRequest)(nil),            // 186: lightbits.api.duros.v2.CreateIDPConfigurationRequest
	(*UpdateIDPConfigurationRequest)(nil),            // 187: lightbits.api.duros.v2.UpdateIDPConfigurationRequest
	(*ListIDPConfigurationsRequest)(nil),             // 188: lightbits.api.duros.v2.ListIDPConfigurationsRequest
	(*ListIDPConfigurationsResponse)(nil),            // 189: lightbits.api.duros.v2.ListIDPConfigurationsResponse
	(*GetIDPConfigurationRequest)(nil),               // 190: lightbits.api.duros.v2.GetIDPConfigurationRequest
	(*DeleteIDPConfigurationRequest)(nil),            // 191: lightbits.api.duros.v2.DeleteIDPConfigurationRequest
	(*DeleteIDPConfigurationResponse)(nil),           // 192: lightbits.api.duros.v2.DeleteIDPConfigurationResponse
	(*IdpClientConf)(nil),                            // 193: lightbits.api.duros.v2.IdpClientConf
	(*CreateIdpClientConfRequest)(nil),               // 194: lightbits.api.duros.v2.CreateIdpClientConfRequest
	(*UpdateIdpClientConfRequest)(nil),               // 195: lightbits.api.duros.v2.UpdateIdpClientConfRequest
	(*GetIdpClientConfRequest)(nil),                  // 196: lightbits.api.duros.v2.GetIdpClientConfRequest
	(*DeleteIdpClientConfRequest)(nil),               // 197: lightbits.api.duros.v2.DeleteIdpClientConfRequest
	(*DeleteIdpClientConfResponse)(nil),              // 198: lightbits.api.duros.v2.DeleteIdpClientConfResponse
	(*ListIdpClientConfsRequest)(nil),                // 199: lightbits.api.duros.v2.ListIdpClientConfsRequest
	(*ListIdpClientConfsResponse)(nil),               // 200: lightbits.api.duros.v2.ListIdpClientConfsResponse
	(*AuthMapEntry)(nil),                             // 201: lightbits.api.duros.v2.AuthMapEntry
	(*CreateAuthMapEntryRequest)(nil),                // 202: lightbits.api.duros.v2.CreateAuthMapEntryRequest
	(*UpdateAuthMapEntryRequest)(nil),                // 203: lightbits.api.duros.v2.UpdateAuthMapEntryRequest
	(*DeleteAuthMapEntryRequest)(nil),                // 204: lightbits.api.duros.v2.DeleteAuthMapEntryRequest
	(*GetAuthMapEntryRequest)(nil),                   // 205: lightbits.api.duros.v2.GetAuthMapEntryRequest
	(*ListAuthMapEntriesRequest)(nil),                // 206: lightbits.api.duros.v2.ListAuthMapEntriesRequest
	(*DeleteAuthMapEntryResponse)(nil),               // 207: lightbits.api.duros.v2.DeleteAuthMapEntryResponse
	(*ListAuthMapEntriesResponse)(nil),               // 208: lightbits.api.duros.v2.ListAuthMapEntriesResponse
	(*EnableFederatedAuthenticationRequest)(nil),     // 209: lightbits.api.duros.v2.EnableFederatedAuthenticationRequest
	(*EnableFederatedAuthenticationResponse)(nil),    // 210: lightbits.api.duros.v2.EnableFederatedAuthenticationResponse
	(*DisableFederatedAuthenticationRequest)(nil),    // 211: lightbits.api.duros.v2.DisableFederatedAuthenticationRequest
	(*DisableFederatedAuthenticationResponse)(nil),   // 212: lightbits.api.duros.v2.DisableFederatedAuthenticationResponse
	(*GetFederatedAuthenticationStatusResponse)(nil), // 213: lightbits.api.duros.v2.GetFederatedAuthenticationStatusResponse
	nil,                                     // 214: lightbits.api.duros.v2.ListFeatureFlagsResponse.FeatureFlagsEntry
	nil,                                     // 215: lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMapEntry
	(*QoSRateLimitPolicy_QoSLimitIOPS)(nil), // 216: lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPS
	(*QoSRateLimitPolicy_QoSLimitBW)(nil),   // 217: lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitBW
	(*QoSRateLimitPolicy_QoSLimitIOPSPerGB)(nil), // 218: lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPSPerGB
	(*GetClusterRootKeyResponse_KeyObject)(nil),  // 219: lightbits.api.duros.v2.GetClusterRootKeyResponse.KeyObject
	(*Label)(nil),                            // 220: lightbits.api.duros.v2.Label
	(*durationpb.Duration)(nil),              // 221: google.protobuf.Duration
	(*ProxyInfo)(nil),                        // 222: lightbits.api.duros.v2.ProxyInfo
	(*timestamppb.Timestamp)(nil),            // 223: google.protobuf.Timestamp
	(*NvmeDeviceStatisticsApi)(nil),          // 224: lightbits.api.duros.v2.NvmeDeviceStatisticsApi
	(*NodeStatisticsApi)(nil),                // 225: lightbits.api.duros.v2.NodeStatisticsApi
	(*ClusterStatisticsApi)(nil),             // 226: lightbits.api.duros.v2.ClusterStatisticsApi
	(*VolumeStatisticsApi)(nil),              // 227: lightbits.api.duros.v2.VolumeStatisticsApi
	(*SnapshotStatisticsApi)(nil),            // 228: lightbits.api.duros.v2.SnapshotStatisticsApi
	(*SchedulePolicy)(nil),                   // 229: lightbits.api.duros.v2.SchedulePolicy
	(AuthorizationMode)(0),                   // 230: lightbits.api.duros.v2.AuthorizationMode
	(*EnableClusterInBandAuthRequest)(nil),   // 231: lightbits.api.duros.v2.EnableClusterInBandAuthRequest
	(*DisableClusterInBandAuthRequest)(nil),  // 232: lightbits.api.duros.v2.DisableClusterInBandAuthRequest
	(*CreateTrustedHostRequest)(nil),         // 233: lightbits.api.duros.v2.CreateTrustedHostRequest
	(*DeleteTrustedHostRequest)(nil),         // 234: lightbits.api.duros.v2.DeleteTrustedHostRequest
	(*GetTrustedHostRequest)(nil),            // 235: lightbits.api.duros.v2.GetTrustedHostRequest
	(*ListTrustedHostsRequest)(nil),          // 236: lightbits.api.duros.v2.ListTrustedHostsRequest
	(*UpdateTrustedHostRequest)(nil),         // 237: lightbits.api.duros.v2.UpdateTrustedHostRequest
	(*SetTrustedHostSecretsRequest)(nil),     // 238: lightbits.api.duros.v2.SetTrustedHostSecretsRequest
	(*GetTrustedHostSecretsRequest)(nil),     // 239: lightbits.api.duros.v2.GetTrustedHostSecretsRequest
	(*CFLoginRequest)(nil),                   // 240: lightbits.api.duros.v2.CFLoginRequest
	(*ListClustersRequest)(nil),              // 241: lightbits.api.duros.v2.ListClustersRequest
	(*DetachClusterRequest)(nil),             // 242: lightbits.api.duros.v2.DetachClusterRequest
	(*AttachClusterRequest)(nil),             // 243: lightbits.api.duros.v2.AttachClusterRequest
	(*GetCFServiceCredentialsRequest)(nil),   // 244: lightbits.api.duros.v2.GetCFServiceCredentialsRequest
	(*ListWorkflowsRequest)(nil),             // 245: lightbits.api.duros.v2.ListWorkflowsRequest
	(*GetWorkflowRequest)(nil),               // 246: lightbits.api.duros.v2.GetWorkflowRequest
	(*httpbody.HttpBody)(nil),                // 247: google.api.HttpBody
	(*EnableClusterInBandAuthResponse)(nil),  // 248: lightbits.api.duros.v2.EnableClusterInBandAuthResponse
	(*DisableClusterInBandAuthResponse)(nil), // 249: lightbits.api.duros.v2.DisableClusterInBandAuthResponse
	(*TrustedHost)(nil),                      // 250: lightbits.api.duros.v2.TrustedHost
	(*DeleteTrustedHostResponse)(nil),        // 251: lightbits.api.duros.v2.DeleteTrustedHostResponse
	(*ListTrustedHostsResponse)(nil),         // 252: lightbits.api.duros.v2.ListTrustedHostsResponse
	(*SetTrustedHostSecretsResponse)(nil),    // 253: lightbits.api.duros.v2.SetTrustedHostSecretsResponse
	(*GetTrustedHostSecretsResponse)(nil),    // 254: lightbits.api.duros.v2.GetTrustedHostSecretsResponse
	(*CFLoginResponse)(nil),                  // 255: lightbits.api.duros.v2.CFLoginResponse
	(*ListClustersResponse)(nil),             // 256: lightbits.api.duros.v2.ListClustersResponse
	(*DetachClusterResponse)(nil),            // 257: lightbits.api.duros.v2.DetachClusterResponse
	(*AttachClusterResponse)(nil),            // 258: lightbits.api.duros.v2.AttachClusterResponse
	(*GetCFServiceCredentialsResponse)(nil),  // 259: lightbits.api.duros.v2.GetCFServiceCredentialsResponse
	(*ListWorkflowsResponse)(nil),            // 260: lightbits.api.duros.v2.ListWorkflowsResponse
	(*GetWorkflowResponse)(nil),              // 261: lightbits.api.duros.v2.GetWorkflowResponse
}
var file_lightbits_api_duros_v2_durosapiv2_proto_depIdxs = []int32{
	35,  // 0: lightbits.api.duros.v2.ListAdminEndpointsResponse.adminEndpoints:type_name -> lightbits.api.duros.v2.AdminEndpoint
	...
	44,  // 4: lightbits.api.duros.v2.ListCredentialsResponse.credentials:type_name -> lightbits.api.duros.v2.Credential
	4,   // 5: lightbits.api.duros.v2.DefaultPolicy.policyType:type_name -> lightbits.api.duros.v2.PolicyType
	50,  // 6: lightbits.api.duros.v2.CreateProjectRequest.defaultPolicies:type_name -> lightbits.api.duros.v2.DefaultPolicy
	50,  // 7: lightbits.api.duros.v2.Project.defaultPolicies:type_name -> lightbits.api.duros.v2.DefaultPolicy
	52,  // 8: lightbits.api.duros.v2.ListProjectsResponse.projects:type_name -> lightbits.api.duros.v2.Project
	58,  // 9: lightbits.api.duros.v2.CreateVolumeRequest.acl:type_name -> lightbits.api.duros.v2.StringList
	58,  // 10: lightbits.api.duros.v2.CreateVolumeRequest.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	...
	161, // 12: lightbits.api.duros.v2.CreateVolumeRequest.placementRestrictions:type_name -> lightbits.api.duros.v2.LabelMatchExpression
	220, // 13: lightbits.api.duros.v2.CreateVolumeRequest.labels:type_name -> lightbits.api.duros.v2.Label
	221, // 14: lightbits.api.duros.v2.DisableServerRequest.permanentFailureTimeout:type_name -> google.protobuf.Duration
	58,  // 15: lightbits.api.duros.v2.UpdateVolumeRequest.acl:type_name -> lightbits.api.duros.v2.StringList
	58,  // 16: lightbits.api.duros.v2.UpdateVolumeRequest.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	220, // 17: lightbits.api.duros.v2.UpdateVolumeRequest.labels:type_name -> lightbits.api.duros.v2.Label
	222, // 18: lightbits.api.duros.v2.UpgradeServerRequest.ProxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	222, // 19: lightbits.api.duros.v2.UpgradeClusterRequest.ProxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	...
	87,  // 21: lightbits.api.duros.v2.ListHostsResponse.connectedHosts:type_name -> lightbits.api.duros.v2.ConnectedHost
	173, // 22: lightbits.api.duros.v2.ListEventsResponse.events:type_name -> lightbits.api.duros.v2.Event
	88,  // 23: lightbits.api.duros.v2.ListNvmeDevicesResponse.NvmeDevices:type_name -> lightbits.api.duros.v2.UserNvmeDevicesResponse
	...
	223, // 25: lightbits.api.duros.v2.UserNvmeDevicesResponse.failureTime:type_name -> google.protobuf.Timestamp
	223, // 26: lightbits.api.duros.v2.UserNvmeDevicesResponse.rebuildCompletionTime:type_name -> google.protobuf.Timestamp
	224, // 27: lightbits.api.duros.v2.UserNvmeDevicesResponse.statistics:type_name -> lightbits.api.duros.v2.NvmeDeviceStatisticsApi
	...
	225, // 30: lightbits.api.duros.v2.DurosNodeInfo.statistics:type_name -> lightbits.api.duros.v2.NodeStatisticsApi
	89,  // 31: lightbits.api.duros.v2.ListNodesResponse.nodes:type_name -> lightbits.api.duros.v2.DurosNodeInfo
	111, // 32: lightbits.api.duros.v2.ListVolumesResponse.volumes:type_name -> lightbits.api.duros.v2.Volume
	...
	114, // 34: lightbits.api.duros.v2.ListServersResponse.servers:type_name -> lightbits.api.duros.v2.Server
	108, // 35: lightbits.api.duros.v2.ClusterUpgradeStatusResponse.cluster:type_name -> lightbits.api.duros.v2.ClusterInfo
	114, // 36: lightbits.api.duros.v2.ListUpgradeStatusResponse.servers:type_name -> lightbits.api.duros.v2.Server
	...
	223, // 38: lightbits.api.duros.v2.ClusterLastUpgrade.StartTime:type_name -> google.protobuf.Timestamp
	223, // 39: lightbits.api.duros.v2.ClusterLastUpgrade.EndTime:type_name -> google.protobuf.Timestamp
	226, // 40: lightbits.api.duros.v2.ClusterInfo.statistics:type_name -> lightbits.api.duros.v2.ClusterStatisticsApi
	110, // 41: lightbits.api.duros.v2.ClusterInfo.health:type_name -> lightbits.api.duros.v2.ClusterHealth
	107, // 42: lightbits.api.duros.v2.ClusterInfo.lastUpgrade:type_name -> lightbits.api.duros.v2.ClusterLastUpgrade
	14,  // 43: lightbits.api.duros.v2.ClusterInfo.inBandAuthMode:type_name -> lightbits.api.duros.v2.ClusterInfo.AuthenticationMode
	178, // 44: lightbits.api.duros.v2.ClusterInfo.encryptionStatus:type_name -> lightbits.api.duros.v2.ClusterEncryptionStatus
	180, // 45: lightbits.api.duros.v2.ClusterInfo.federatedAuthenticationStatus:type_name -> lightbits.api.duros.v2.FederatedAuthenticationStatus
	107, // 46: lightbits.api.duros.v2.ClusterInfoV2.lastUpgrade:type_name -> lightbits.api.duros.v2.ClusterLastUpgrade
	178, // 47: lightbits.api.duros.v2.ClusterInfoV2.encryptionStatus:type_name -> lightbits.api.duros.v2.ClusterEncryptionStatus
	...
	58,  // 51: lightbits.api.duros.v2.Volume.acl:type_name -> lightbits.api.duros.v2.StringList
	227, // 52: lightbits.api.duros.v2.Volume.statistics:type_name -> lightbits.api.duros.v2.VolumeStatisticsApi
	58,  // 53: lightbits.api.duros.v2.Volume.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	161, // 54: lightbits.api.duros.v2.Volume.placementRestrictions:type_name -> lightbits.api.duros.v2.LabelMatchExpression
	223, // 55: lightbits.api.duros.v2.Volume.creationTime:type_name -> google.protobuf.Timestamp
	220, // 56: lightbits.api.duros.v2.Volume.labels:type_name -> lightbits.api.duros.v2.Label
	...
	223, // 58: lightbits.api.duros.v2.ServerEvictionStatus.startTime:type_name -> google.protobuf.Timestamp
	223, // 59: lightbits.api.duros.v2.ServerEvictionStatus.endTime:type_name -> google.protobuf.Timestamp
	...
	223, // 61: lightbits.api.duros.v2.ServerLastUpgrade.StartTime:type_name -> google.protobuf.Timestamp
	223, // 62: lightbits.api.duros.v2.ServerLastUpgrade.EndTime:type_name -> google.protobuf.Timestamp
	...
	113, // 66: lightbits.api.duros.v2.Server.LastUpgrade:type_name -> lightbits.api.duros.v2.ServerLastUpgrade
	112, // 67: lightbits.api.duros.v2.Server.LastEviction:type_name -> lightbits.api.duros.v2.ServerEvictionStatus
	15,  // 68: lightbits.api.duros.v2.Server.health:type_name -> lightbits.api.duros.v2.ClusterHealth.State
	221, // 69: lightbits.api.duros.v2.Server.ServerPermanenetFailureTimeout:type_name -> google.protobuf.Duration
	117, // 70: lightbits.api.duros.v2.GetRoleResponse.role:type_name -> lightbits.api.duros.v2.Role
	117, // 71: lightbits.api.duros.v2.ListRolesResponse.roles:type_name -> lightbits.api.duros.v2.Role
	23,  // 72: lightbits.api.duros.v2.Snapshot.state:type_name -> lightbits.api.duros.v2.Snapshot.StateEnum
	223, // 73: lightbits.api.duros.v2.Snapshot.creationTime:type_name -> google.protobuf.Timestamp
	221, // 74: lightbits.api.duros.v2.Snapshot.retentionTime:type_name -> google.protobuf.Duration
	58,  // 75: lightbits.api.duros.v2.Snapshot.acl:type_name -> lightbits.api.duros.v2.StringList
	58,  // 76: lightbits.api.duros.v2.Snapshot.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	228, // 77: lightbits.api.duros.v2.Snapshot.statistics:type_name -> lightbits.api.duros.v2.SnapshotStatisticsApi
	220, // 78: lightbits.api.duros.v2.Snapshot.labels:type_name -> lightbits.api.duros.v2.Label
	221, // 79: lightbits.api.duros.v2.CreateSnapshotRequest.retentionTime:type_name -> google.protobuf.Duration
	120, // 80: lightbits.api.duros.v2.ListSnapshotsResponse.snapshots:type_name -> lightbits.api.duros.v2.Snapshot
	214, // 81: lightbits.api.duros.v2.ListFeatureFlagsResponse.featureFlags:type_name -> lightbits.api.duros.v2.ListFeatureFlagsResponse.FeatureFlagsEntry
	229, // 82: lightbits.api.duros.v2.CreateResourcePolicyRequest.schedulePolicy:type_name -> lightbits.api.duros.v2.SchedulePolicy
	174, // 83: lightbits.api.duros.v2.CreatePolicyRequest.qoSRateLimitPolicy:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy
	174, // 84: lightbits.api.duros.v2.UpdatePolicyRequest.qoSRateLimitPolicy:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy
	229, // 85: lightbits.api.duros.v2.ResourcePolicy.schedulePolicy:type_name -> lightbits.api.duros.v2.SchedulePolicy
	...
	174, // 88: lightbits.api.duros.v2.Policy.QoSRateLimitPolicy:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy
	229, // 89: lightbits.api.duros.v2.UpdateResourcePolicyRequest.schedulePolicy:type_name -> lightbits.api.duros.v2.SchedulePolicy
	139, // 90: lightbits.api.duros.v2.ListPoliciesResponse.policies:type_name -> lightbits.api.duros.v2.Policy
	138, // 91: lightbits.api.duros.v2.ListResourcePoliciesResponse.resourcePolicies:type_name -> lightbits.api.duros.v2.ResourcePolicy
	175, // 92: lightbits.api.duros.v2.ListResourcePoliciesResponse.defaultResourcePolicies:type_name -> lightbits.api.duros.v2.DefaultGlobalResourcePolicy
	153, // 93: lightbits.api.duros.v2.UpdateClusterConfigParamRequest.configParam:type_name -> lightbits.api.duros.v2.ClusterConfigParam
	153, // 94: lightbits.api.duros.v2.ListClusterConfigParamsResponse.values:type_name -> lightbits.api.duros.v2.ClusterConfigParam
	...
	160, // 97: lightbits.api.duros.v2.LabelMatchExpression.labelValueKeyPairs:type_name -> lightbits.api.duros.v2.LabelValueKeyPair
	162, // 98: lightbits.api.duros.v2.VolumeComponentInfoList.VolumeComponentInfoList:type_name -> lightbits.api.duros.v2.ComponentVolumeInfo
	215, // 99: lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMap:type_name -> lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMapEntry
	170, // 100: lightbits.api.duros.v2.ListChangedBlocksResponse.lbaRanges:type_name -> lightbits.api.duros.v2.LBARange
	223, // 101: lightbits.api.duros.v2.Event.Time:type_name -> google.protobuf.Timestamp
	...
	164, // 105: lightbits.api.duros.v2.Event.ComponentVolumesInfo:type_name -> lightbits.api.duros.v2.ComponentVolumesInfo
	167, // 106: lightbits.api.duros.v2.Event.ComponentNVMeSSDInfo:type_name -> lightbits.api.duros.v2.ComponentNVMeSSDInfo
	165, // 107: lightbits.api.duros.v2.Event.ComponentNodeInfo:type_name -> lightbits.api.duros.v2.ComponentNodeInfo
	168, // 108: lightbits.api.duros.v2.Event.ComponentServerInfo:type_name -> lightbits.api.duros.v2.ComponentServerInfo
	166, // 109: lightbits.api.duros.v2.Event.ComponentClusterInfo:type_name -> lightbits.api.duros.v2.ComponentClusterInfo
	169, // 110: lightbits.api.duros.v2.Event.ComponentDataIntegrityInfo:type_name -> lightbits.api.duros.v2.ComponentDataIntegrityInfo
	3,   // 111: lightbits.api.duros.v2.QoSRateLimitPolicy.policyVisibility:type_name -> lightbits.api.duros.v2.PolicyVisibility
	216, // 112: lightbits.api.duros.v2.QoSRateLimitPolicy.limitIOPS:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPS
	217, // 113: lightbits.api.duros.v2.QoSRateLimitPolicy.limitBw:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitBW
	218, // 114: lightbits.api.duros.v2.QoSRateLimitPolicy.limitIOPSPerGB:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPSPerGB
	4,   // 115: lightbits.api.duros.v2.DefaultGlobalResourcePolicy.policyType:type_name -> lightbits.api.duros.v2.PolicyType
	50,  // 116: lightbits.api.duros.v2.UpdateProjectRequest.defaultPolicies:type_name -> lightbits.api.duros.v2.DefaultPolicy
	...
	223, // 118: lightbits.api.duros.v2.ClusterEncryptionStatus.kekUpdateDate:type_name -> google.protobuf.Timestamp
	32,  // 119: lightbits.api.duros.v2.ClusterEncryptionStatus.rotationState:type_name -> lightbits.api.duros.v2.ClusterEncryptionStatus.RotationState
	5,   // 120: lightbits.api.duros.v2.IdpHealthInfo.idpHealthStatus:type_name -> lightbits.api.duros.v2.IdpHealthStatus
	223, // 121: lightbits.api.duros.v2.IdpHealthInfo.timestamp:type_name -> google.protobuf.Timestamp
	179, // 122: lightbits.api.duros.v2.FederatedAuthenticationStatus.idpHealthInfos:type_name -> lightbits.api.duros.v2.IdpHealthInfo
	219, // 123: lightbits.api.duros.v2.GetClusterRootKeyResponse.key:type_name -> lightbits.api.duros.v2.GetClusterRootKeyResponse.KeyObject
	33,  // 124: lightbits.api.duros.v2.IDPConfiguration.state:type_name -> lightbits.api.duros.v2.IDPConfiguration.IDPConfigurationState
	6,   // 125: lightbits.api.duros.v2.IDPConfiguration.type:type_name -> lightbits.api.duros.v2.IDPType
	222, // 126: lightbits.api.duros.v2.IDPConfiguration.proxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	6,   // 127: lightbits.api.duros.v2.CreateIDPConfigurationRequest.type:type_name -> lightbits.api.duros.v2.IDPType
	222, // 128: lightbits.api.duros.v2.CreateIDPConfigurationRequest.proxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	6,   // 129: lightbits.api.duros.v2.UpdateIDPConfigurationRequest.type:type_name -> lightbits.api.duros.v2.IDPType
	222, // 130: lightbits.api.duros.v2.UpdateIDPConfigurationRequest.proxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	185, // 131: lightbits.api.duros.v2.ListIDPConfigurationsResponse.idpConfigurations:type_name -> lightbits.api.duros.v2.IDPConfiguration
	230, // 132: lightbits.api.duros.v2.IdpClientConf.authzMode:type_name -> lightbits.api.duros.v2.AuthorizationMode
	230, // 133: lightbits.api.duros.v2.CreateIdpClientConfRequest.authzMode:type_name -> lightbits.api.duros.v2.AuthorizationMode
	193, // 134: lightbits.api.duros.v2.ListIdpClientConfsResponse.idpClientConfigurations:type_name -> lightbits.api.duros.v2.IdpClientConf
	201, // 135: lightbits.api.duros.v2.ListAuthMapEntriesResponse.authMapEntries:type_name -> lightbits.api.duros.v2.AuthMapEntry
	7,   // 136: lightbits.api.duros.v2.GetFederatedAuthenticationStatusResponse.federatedAuthenticationState:type_name -> lightbits.api.duros.v2.fedAuthState
	127, // 137: lightbits.api.duros.v2.ListFeatureFlagsResponse.FeatureFlagsEntry.value:type_name -> lightbits.api.duros.v2.FeatureFlagStatus
	163, // 138: lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMapEntry.value:type_name -> lightbits.api.duros.v2.VolumeComponentInfoList
	59,  // 139: lightbits.api.duros.v2.DurosAPI.GetVersion:input_type -> lightbits.api.duros.v2.GetVersionRequest
	60,  // 140: lightbits.api.duros.v2.DurosAPI.CreateVolume:input_type -> lightbits.api.duros.v2.CreateVolumeRequest
	61,  // 141: lightbits.api.duros.v2.DurosAPI.DeleteVolume:input_type -> lightbits.api.duros.v2.DeleteVolumeRequest
	83,  // 142: lightbits.api.duros.v2.DurosAPI.ListVolumes:input_type -> lightbits.api.duros.v2.ListVolumeRequest
	79,  // 143: lightbits.api.duros.v2.DurosAPI.ListEvents:input_type -> lightbits.api.duros.v2.ListEventsRequest
	75,  // 144: lightbits.api.duros.v2.DurosAPI.GetHost:input_type -> lightbits.api.duros.v2.GetHostRequest
	76,  // 145: lightbits.api.duros.v2.DurosAPI.ListHosts:input_type -> lightbits.api.duros.v2.ListHostsRequest
	81,  // 146: lightbits.api.duros.v2.DurosAPI.GetVolume:input_type -> lightbits.api.duros.v2.GetVolumeRequest
	78,  // 147: lightbits.api.duros.v2.DurosAPI.ListNodes:input_type -> lightbits.api.duros.v2.ListNodeRequest
	82,  // 148: lightbits.api.duros.v2.DurosAPI.GetNode:input_type -> lightbits.api.duros.v2.GetNodeRequest
	84,  // 149: lightbits.api.duros.v2.DurosAPI.ListNvmeDevices:input_type -> lightbits.api.duros.v2.ListNvmeDevicesRequest
	85,  // 150: lightbits.api.duros.v2.DurosAPI.GetNvmeDevice:input_type -> lightbits.api.duros.v2.GetNvmeDeviceRequest
	34,  // 151: lightbits.api.duros.v2.DurosAPI.FetchLogs:input_type -> lightbits.api.duros.v2.LogRequest
	72,  // 152: lightbits.api.duros.v2.DurosAPI.GetCluster:input_type -> lightbits.api.duros.v2.GetClusterRequest
	72,  // 153: lightbits.api.duros.v2.DurosAPI.GetClusterInfo:input_type -> lightbits.api.duros.v2.GetClusterRequest
	73,  // 154: lightbits.api.duros.v2.DurosAPI.UpdateNvmeDevice:input_type -> lightbits.api.duros.v2.UpdateNvmeDeviceRequest
	74,  // 155: lightbits.api.duros.v2.DurosAPI.AddNvmeDevice:input_type -> lightbits.api.duros.v2.AddNvmeDeviceRequest
	68,  // 156: lightbits.api.duros.v2.DurosAPI.UpdateVolume:input_type -> lightbits.api.duros.v2.UpdateVolumeRequest
	102, // 157: lightbits.api.duros.v2.DurosAPI.GetServer:input_type -> lightbits.api.duros.v2.GetServerRequest
	101, // 158: lightbits.api.duros.v2.DurosAPI.ListServers:input_type -> lightbits.api.duros.v2.ListServersRequest
	69,  // 159: lightbits.api.duros.v2.DurosAPI.UpgradeServer:input_type -> lightbits.api.duros.v2.UpgradeServerRequest
	70,  // 160: lightbits.api.duros.v2.DurosAPI.UpgradeCluster:input_type -> lightbits.api.duros.v2.UpgradeClusterRequest
	71,  // 161: lightbits.api.duros.v2.DurosAPI.EnableClusterEncryption:input_type -> lightbits.api.duros.v2.EnableClusterEncryptionRequest
	67,  // 162: lightbits.api.duros.v2.DurosAPI.CreateServer:input_type -> lightbits.api.duros.v2.CreateServerRequest
	66,  // 163: lightbits.api.duros.v2.DurosAPI.ReplaceNode:input_type -> lightbits.api.duros.v2.ReplaceNodeRequest
	65,  // 164: lightbits.api.duros.v2.DurosAPI.DeleteServer:input_type -> lightbits.api.duros.v2.DeleteServerRequest
	63,  // 165: lightbits.api.duros.v2.DurosAPI.EnableServer:input_type -> lightbits.api.duros.v2.EnableServerRequest
	64,  // 166: lightbits.api.duros.v2.DurosAPI.DisableServer:input_type -> lightbits.api.duros.v2.DisableServerRequest
	51,  // 167: lightbits.api.duros.v2.DurosAPI.CreateProject:input_type -> lightbits.api.duros.v2.CreateProjectRequest
	176, // 168: lightbits.api.duros.v2.DurosAPI.UpdateProject:input_type -> lightbits.api.duros.v2.UpdateProjectRequest
	53,  // 169: lightbits.api.duros.v2.DurosAPI.DeleteProject:input_type -> lightbits.api.duros.v2.DeleteProjectRequest
	55,  // 170: lightbits.api.duros.v2.DurosAPI.ListProjects:input_type -> lightbits.api.duros.v2.ListProjectsRequest
	57,  // 171: lightbits.api.duros.v2.DurosAPI.GetProject:input_type -> lightbits.api.duros.v2.GetProjectRequest
	43,  // 172: lightbits.api.duros.v2.DurosAPI.CreateCredential:input_type -> lightbits.api.duros.v2.CreateCredentialRequest
	45,  // 173: lightbits.api.duros.v2.DurosAPI.DeleteCredential:input_type -> lightbits.api.duros.v2.DeleteCredentialRequest
	47,  // 174: lightbits.api.duros.v2.DurosAPI.ListCredentials:input_type -> lightbits.api.duros.v2.ListCredentialsRequest
	49,  // 175: lightbits.api.duros.v2.DurosAPI.GetCredential:input_type -> lightbits.api.duros.v2.GetCredentialRequest
	115, // 176: lightbits.api.duros.v2.DurosAPI.GetRole:input_type -> lightbits.api.duros.v2.GetRoleRequest
	118, // 177: lightbits.api.duros.v2.DurosAPI.ListRoles:input_type -> lightbits.api.duros.v2.ListRolesRequest
	39,  // 178: lightbits.api.duros.v2.DurosAPI.CreateAdminEndpoint:input_type -> lightbits.api.duros.v2.CreateAdminEndpointRequest
	41,  // 179: lightbits.api.duros.v2.DurosAPI.DeleteAdminEndpoint:input_type -> lightbits.api.duros.v2.DeleteAdminEndpointRequest
	38,  // 180: lightbits.api.duros.v2.DurosAPI.ListAdminEndpoints:input_type -> lightbits.api.duros.v2.ListAdminEndpointsRequest
	40,  // 181: lightbits.api.duros.v2.DurosAPI.UpdateAdminEndpoint:input_type -> lightbits.api.duros.v2.UpdateAdminEndpointRequest
	36,  // 182: lightbits.api.duros.v2.DurosAPI.GetAdminEndpoint:input_type -> lightbits.api.duros.v2.GetAdminEndpointRequest
	134, // 183: lightbits.api.duros.v2.DurosAPI.CreateResourcePolicy:input_type -> lightbits.api.duros.v2.CreateResourcePolicyRequest
	135, // 184: lightbits.api.duros.v2.DurosAPI.CreatePolicy:input_type -> lightbits.api.duros.v2.CreatePolicyRequest
	136, // 185: lightbits.api.duros.v2.DurosAPI.UpdatePolicy:input_type -> lightbits.api.duros.v2.UpdatePolicyRequest
	140, // 186: lightbits.api.duros.v2.DurosAPI.UpdateResourcePolicy:input_type -> lightbits.api.duros.v2.UpdateResourcePolicyRequest
	146, // 187: lightbits.api.duros.v2.DurosAPI.GetPolicy:input_type -> lightbits.api.duros.v2.GetPolicyRequest
	142, // 188: lightbits.api.duros.v2.DurosAPI.ListPolicies:input_type -> lightbits.api.duros.v2.ListPoliciesRequest
	144, // 189: lightbits.api.duros.v2.DurosAPI.ListResourcePolicies:input_type -> lightbits.api.duros.v2.ListResourcePoliciesRequest
	147, // 190: lightbits.api.duros.v2.DurosAPI.GetResourcePolicy:input_type -> lightbits.api.duros.v2.GetResourcePolicyRequest
	148, // 191: lightbits.api.duros.v2.DurosAPI.DeleteResourcePolicy:input_type -> lightbits.api.duros.v2.DeleteResourcePolicyRequest
	150, // 192: lightbits.api.duros.v2.DurosAPI.DeletePolicy:input_type -> lightbits.api.duros.v2.DeletePolicyRequest
	122, // 193: lightbits.api.duros.v2.DurosAPI.CreateSnapshot:input_type -> lightbits.api.duros.v2.CreateSnapshotRequest
	124, // 194: lightbits.api.duros.v2.DurosAPI.GetSnapshot:input_type -> lightbits.api.duros.v2.GetSnapshotRequest
	123, // 195: lightbits.api.duros.v2.DurosAPI.ListSnapshots:input_type -> lightbits.api.duros.v2.ListSnapshotsRequest
	121, // 196: lightbits.api.duros.v2.DurosAPI.DeleteSnapshot:input_type -> lightbits.api.duros.v2.DeleteSnapshotRequest
	128, // 197: lightbits.api.duros.v2.DurosAPI.GetFeatureFlag:input_type -> lightbits.api.duros.v2.GetFeatureFlagRequest
	129, // 198: lightbits.api.duros.v2.DurosAPI.EnableFeatureFlag:input_type -> lightbits.api.duros.v2.EnableFeatureFlagRequest
	130, // 199: lightbits.api.duros.v2.DurosAPI.DisableFeatureFlag:input_type -> lightbits.api.duros.v2.DisableFeatureFlagRequest
	132, // 200: lightbits.api.duros.v2.DurosAPI.ListFeatureFlags:input_type -> lightbits.api.duros.v2.ListFeatureFlagsRequest
	152, // 201: lightbits.api.duros.v2.DurosAPI.GetClusterConfigParam:input_type -> lightbits.api.duros.v2.GetClusterConfigParamRequest
	154, // 202: lightbits.api.duros.v2.DurosAPI.UpdateClusterConfigParam:input_type -> lightbits.api.duros.v2.UpdateClusterConfigParamRequest
	158, // 203: lightbits.api.duros.v2.DurosAPI.ListClusterConfigParams:input_type -> lightbits.api.duros.v2.ListClusterConfigParamsRequest
	155, // 204: lightbits.api.duros.v2.DurosAPI.RollbackVolume:input_type -> lightbits.api.duros.v2.RollbackVolumeRequest
	171, // 205: lightbits.api.duros.v2.DurosAPI.ListChangedBlocks:input_type -> lightbits.api.duros.v2.ListChangedBlocksRequest
	181, // 206: lightbits.api.duros.v2.DurosAPI.RotateClusterRootKey:input_type -> lightbits.api.duros.v2.RotateClusterRootKeyRequest
	183, // 207: lightbits.api.duros.v2.DurosAPI.GetClusterRootKey:input_type -> lightbits.api.duros.v2.GetClusterRootKeyRequest
	186, // 208: lightbits.api.duros.v2.DurosAPI.CreateIdpConfiguration:input_type -> lightbits.api.duros.v2.CreateIDPConfigurationRequest
	191, // 209: lightbits.api.duros.v2.DurosAPI.DeleteIdpConfiguration:input_type -> lightbits.api.duros.v2.DeleteIDPConfigurationRequest
	187, // 210: lightbits.api.duros.v2.DurosAPI.UpdateIdpConfiguration:input_type -> lightbits.api.duros.v2.UpdateIDPConfigurationRequest
	188, // 211: lightbits.api.duros.v2.DurosAPI.ListIdpConfigurations:input_type -> lightbits.api.duros.v2.ListIDPConfigurationsRequest
	190, // 212: lightbits.api.duros.v2.DurosAPI.GetIdpConfiguration:input_type -> lightbits.api.duros.v2.GetIDPConfigurationRequest
	194, // 213: lightbits.api.duros.v2.DurosAPI.CreateIdpClientConf:input_type -> lightbits.api.duros.v2.CreateIdpClientConfRequest
	197, // 214: lightbits.api.duros.v2.DurosAPI.DeleteIdpClientConf:input_type -> lightbits.api.duros.v2.DeleteIdpClientConfRequest
	195, // 215: lightbits.api.duros.v2.DurosAPI.UpdateIdpClientConf:input_type -> lightbits.api.duros.v2.UpdateIdpClientConfRequest
	199, // 216: lightbits.api.duros.v2.DurosAPI.ListIdpClientConfs:input_type -> lightbits.api.duros.v2.ListIdpClientConfsRequest
	196, // 217: lightbits.api.duros.v2.DurosAPI.GetIdpClientConf:input_type -> lightbits.api.duros.v2.GetIdpClientConfRequest
	202, // 218: lightbits.api.duros.v2.DurosAPI.CreateAuthMapEntry:input_type -> lightbits.api.duros.v2.CreateAuthMapEntryRequest
	203, // 219: lightbits.api.duros.v2.DurosAPI.UpdateAuthMapEntry:input_type -> lightbits.api.duros.v2.UpdateAuthMapEntryRequest
	204, // 220: lightbits.api.duros.v2.DurosAPI.DeleteAuthMapEntry:input_type -> lightbits.api.duros.v2.DeleteAuthMapEntryRequest
	205, // 221: lightbits.api.duros.v2.DurosAPI.GetAuthMapEntry:input_type -> lightbits.api.duros.v2.GetAuthMapEntryRequest
	206, // 222: lightbits.api.duros.v2.DurosAPI.ListAuthMapEntries:input_type -> lightbits.api.duros.v2.ListAuthMapEntriesRequest
	231, // 223: lightbits.api.duros.v2.DurosAPI.EnableClusterInBandAuth:input_type -> lightbits.api.duros.v2.EnableClusterInBandAuthRequest
	232, // 224: lightbits.api.duros.v2.DurosAPI.DisableClusterInBandAuth:input_type -> lightbits.api.duros.v2.DisableClusterInBandAuthRequest
	233, // 225: lightbits.api.duros.v2.DurosAPI.CreateTrustedHost:input_type -> lightbits.api.duros.v2.CreateTrustedHostRequest
	234, // 226: lightbits.api.duros.v2.DurosAPI.DeleteTrustedHost:input_type -> lightbits.api.duros.v2.DeleteTrustedHostRequest
	235, // 227: lightbits.api.duros.v2.DurosAPI.GetTrustedHost:input_type -> lightbits.api.duros.v2.GetTrustedHostRequest
	236, // 228: lightbits.api.duros.v2.DurosAPI.ListTrustedHosts:input_type -> lightbits.api.duros.v2.ListTrustedHostsRequest
	237, // 229: lightbits.api.duros.v2.DurosAPI.UpdateTrustedHost:input_type -> lightbits.api.duros.v2.UpdateTrustedHostRequest
	238, // 230: lightbits.api.duros.v2.DurosAPI.SetTrustedHostSecret:input_type -> lightbits.api.duros.v2.SetTrustedHostSecretsRequest
	239, // 231: lightbits.api.duros.v2.DurosAPI.GetTrustedHostSecret:input_type -> lightbits.api.duros.v2.GetTrustedHostSecretsRequest
	209, // 232: lightbits.api.duros.v2.DurosAPI.EnableFederatedAuthentication:input_type -> lightbits.api.duros.v2.EnableFederatedAuthenticationRequest
	211, // 233: lightbits.api.duros.v2.DurosAPI.DisableFederatedAuthentication:input_type -> lightbits.api.duros.v2.DisableFederatedAuthenticationRequest
	240, // 234: lightbits.api.duros.v2.DurosAPI.CFLogin:input_type -> lightbits.api.duros.v2.CFLoginRequest
	241, // 235: lightbits.api.duros.v2.DurosAPI.ListClusters:input_type -> lightbits.api.duros.v2.ListClustersRequest
	242, // 236: lightbits.api.duros.v2.DurosAPI.DetachCluster:input_type -> lightbits.api.duros.v2.DetachClusterRequest
	243, // 237: lightbits.api.duros.v2.DurosAPI.AttachCluster:input_type -> lightbits.api.duros.v2.AttachClusterRequest
	244, // 238: lightbits.api.duros.v2.DurosAPI.GetCFServiceCredentials:input_type -> lightbits.api.duros.v2.GetCFServiceCredentialsRequest
	245, // 239: lightbits.api.duros.v2.DurosAPI.ListWorkflows:input_type -> lightbits.api.duros.v2.ListWorkflowsRequest
	246, // 240: lightbits.api.duros.v2.DurosAPI.GetWorkflow:input_type -> lightbits.api.duros.v2.GetWorkflowRequest
	106, // 241: lightbits.api.duros.v2.DurosAPI.GetVersion:output_type -> lightbits.api.duros.v2.Version
	111, // 242: lightbits.api.duros.v2.DurosAPI.CreateVolume:output_type -> lightbits.api.duros.v2.Volume
	62,  // 243: lightbits.api.duros.v2.DurosAPI.DeleteVolume:output_type -> lightbits.api.duros.v2.DeleteVolumeResponse
	91,  // 244: lightbits.api.duros.v2.DurosAPI.ListVolumes:output_type -> lightbits.api.duros.v2.ListVolumesResponse
	80,  // 245: lightbits.api.duros.v2.DurosAPI.ListEvents:output_type -> lightbits.api.duros.v2.ListEventsResponse
	87,  // 246: lightbits.api.duros.v2.DurosAPI.GetHost:output_type -> lightbits.api.duros.v2.ConnectedHost
	77,  // 247: lightbits.api.duros.v2.DurosAPI.ListHosts:output_type -> lightbits.api.duros.v2.ListHostsResponse
	111, // 248: lightbits.api.duros.v2.DurosAPI.GetVolume:output_type -> lightbits.api.duros.v2.Volume
	90,  // 249: lightbits.api.duros.v2.DurosAPI.ListNodes:output_type -> lightbits.api.duros.v2.ListNodesResponse
	89,  // 250: lightbits.api.duros.v2.DurosAPI.GetNode:output_type -> lightbits.api.duros.v2.DurosNodeInfo
	86,  // 251: lightbits.api.duros.v2.DurosAPI.ListNvmeDevices:output_type -> lightbits.api.duros.v2.ListNvmeDevicesResponse
	88,  // 252: lightbits.api.duros.v2.DurosAPI.GetNvmeDevice:output_type -> lightbits.api.duros.v2.UserNvmeDevicesResponse
	247, // 253: lightbits.api.duros.v2.DurosAPI.FetchLogs:output_type -> google.api.HttpBody
	108, // 254: lightbits.api.duros.v2.DurosAPI.GetCluster:output_type -> lightbits.api.duros.v2.ClusterInfo
	109, // 255: lightbits.api.duros.v2.DurosAPI.GetClusterInfo:output_type -> lightbits.api.duros.v2.ClusterInfoV2
	92,  // 256: lightbits.api.duros.v2.DurosAPI.UpdateNvmeDevice:output_type -> lightbits.api.duros.v2.UpdateNvmeDeviceResponse
	93,  // 257: lightbits.api.duros.v2.DurosAPI.AddNvmeDevice:output_type -> lightbits.api.duros.v2.AddNvmeDeviceResponse
	94,  // 258: lightbits.api.duros.v2.DurosAPI.UpdateVolume:output_type -> lightbits.api.duros.v2.UpdateVolumeResponse
	114, // 259: lightbits.api.duros.v2.DurosAPI.GetServer:output_type -> lightbits.api.duros.v2.Server
	103, // 260: lightbits.api.duros.v2.DurosAPI.ListServers:output_type -> lightbits.api.duros.v2.ListServersResponse
	95,  // 261: lightbits.api.duros.v2.DurosAPI.UpgradeServer:output_type -> lightbits.api.duros.v2.UpgradeServerResponse
	96,  // 262: lightbits.api.duros.v2.DurosAPI.UpgradeCluster:output_type -> lightbits.api.duros.v2.UpgradeClusterResponse
	97,  // 263: lightbits.api.duros.v2.DurosAPI.EnableClusterEncryption:output_type -> lightbits.api.duros.v2.EnableClusterEncryptionResponse
	114, // 264: lightbits.api.duros.v2.DurosAPI.CreateServer:output_type -> lightbits.api.duros.v2.Server
	98,  // 265: lightbits.api.duros.v2.DurosAPI.ReplaceNode:output_type -> lightbits.api.duros.v2.ReplaceNodeResponse
	99,  // 266: lightbits.api.duros.v2.DurosAPI.DeleteServer:output_type -> lightbits.api.duros.v2.DeleteServerResponse
	114, // 267: lightbits.api.duros.v2.DurosAPI.EnableServer:output_type -> lightbits.api.duros.v2.Server
	100, // 268: lightbits.api.duros.v2.DurosAPI.DisableServer:output_type -> lightbits.api.duros.v2.DisableServerResponse
	52,  // 269: lightbits.api.duros.v2.DurosAPI.CreateProject:output_type -> lightbits.api.duros.v2.Project
	177, // 270: lightbits.api.duros.v2.DurosAPI.UpdateProject:output_type -> lightbits.api.duros.v2.UpdateProjectResponse
	54,  // 271: lightbits.api.duros.v2.DurosAPI.DeleteProject:output_type -> lightbits.api.duros.v2.DeleteProjectResponse
	56,  // 272: lightbits.api.duros.v2.DurosAPI.ListProjects:output_type -> lightbits.api.duros.v2.ListProjectsResponse
	52,  // 273: lightbits.api.duros.v2.DurosAPI.GetProject:output_type -> lightbits.api.duros.v2.Project
	44,  // 274: lightbits.api.duros.v2.DurosAPI.CreateCredential:output_type -> lightbits.api.duros.v2.Credential
	46,  // 275: lightbits.api.duros.v2.DurosAPI.DeleteCredential:output_type -> lightbits.api.duros.v2.DeleteCredentialResponse
	48,  // 276: lightbits.api.duros.v2.DurosAPI.ListCredentials:output_type -> lightbits.api.duros.v2.ListCredentialsResponse
	44,  // 277: lightbits.api.duros.v2.DurosAPI.GetCredential:output_type -> lightbits.api.duros.v2.Credential
	116, // 278: lightbits.api.duros.v2.DurosAPI.GetRole:output_type -> lightbits.api.duros.v2.GetRoleResponse
	119, // 279: lightbits.api.duros.v2.DurosAPI.ListRoles:output_type -> lightbits.api.duros.v2.ListRolesResponse
	35,  // 280: lightbits.api.duros.v2.DurosAPI.CreateAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	42,  // 281: lightbits.api.duros.v2.DurosAPI.DeleteAdminEndpoint:output_type -> lightbits.api.duros.v2.DeleteAdminEndpointResponse
	37,  // 282: lightbits.api.duros.v2.DurosAPI.ListAdminEndpoints:output_type -> lightbits.api.duros.v2.ListAdminEndpointsResponse
	35,  // 283: lightbits.api.duros.v2.DurosAPI.UpdateAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	35,  // 284: lightbits.api.duros.v2.DurosAPI.GetAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	138, // 285: lightbits.api.duros.v2.DurosAPI.CreateResourcePolicy:output_type -> lightbits.api.duros.v2.ResourcePolicy
	139, // 286: lightbits.api.duros.v2.DurosAPI.CreatePolicy:output_type -> lightbits.api.duros.v2.Policy
	137, // 287: lightbits.api.duros.v2.DurosAPI.UpdatePolicy:output_type -> lightbits.api.duros.v2.UpdatePolicyResponse
	141, // 288: lightbits.api.duros.v2.DurosAPI.UpdateResourcePolicy:output_type -> lightbits.api.duros.v2.UpdateResourcePolicyResponse
	139, // 289: lightbits.api.duros.v2.DurosAPI.GetPolicy:output_type -> lightbits.api.duros.v2.Policy
	143, // 290: lightbits.api.duros.v2.DurosAPI.ListPolicies:output_type -> lightbits.api.duros.v2.ListPoliciesResponse
	145, // 291: lightbits.api.duros.v2.DurosAPI.ListResourcePolicies:output_type -> lightbits.api.duros.v2.ListResourcePoliciesResponse
	138, // 292: lightbits.api.duros.v2.DurosAPI.GetResourcePolicy:output_type -> lightbits.api.duros.v2.ResourcePolicy
	149, // 293: lightbits.api.duros.v2.DurosAPI.DeleteResourcePolicy:output_type -> lightbits.api.duros.v2.DeleteResourcePolicyResponse
	151, // 294: lightbits.api.duros.v2.DurosAPI.DeletePolicy:output_type -> lightbits.api.duros.v2.DeletePolicyResponse
	120, // 295: lightbits.api.duros.v2.DurosAPI.CreateSnapshot:output_type -> lightbits.api.duros.v2.Snapshot
	120, // 296: lightbits.api.duros.v2.DurosAPI.GetSnapshot:output_type -> lightbits.api.duros.v2.Snapshot
	125, // 297: lightbits.api.duros.v2.DurosAPI.ListSnapshots:output_type -> lightbits.api.duros.v2.ListSnapshotsResponse
	126, // 298: lightbits.api.duros.v2.DurosAPI.DeleteSnapshot:output_type -> lightbits.api.duros.v2.DeleteSnapshotResponse
	127, // 299: lightbits.api.duros.v2.DurosAPI.GetFeatureFlag:output_type -> lightbits.api.duros.v2.FeatureFlagStatus
	131, // 300: lightbits.api.duros.v2.DurosAPI.EnableFeatureFlag:output_type -> lightbits.api.duros.v2.SetFeatureFlagResponse
	131, // 301: lightbits.api.duros.v2.DurosAPI.DisableFeatureFlag:output_type -> lightbits.api.duros.v2.SetFeatureFlagResponse
	133, // 302: lightbits.api.duros.v2.DurosAPI.ListFeatureFlags:output_type -> lightbits.api.duros.v2.ListFeatureFlagsResponse
	153, // 303: lightbits.api.duros.v2.DurosAPI.GetClusterConfigParam:output_type -> lightbits.api.duros.v2.ClusterConfigParam
	157, // 304: lightbits.api.duros.v2.DurosAPI.UpdateClusterConfigParam:output_type -> lightbits.api.duros.v2.UpdateClusterConfigParamResponse
	159, // 305: lightbits.api.duros.v2.DurosAPI.ListClusterConfigParams:output_type -> lightbits.api.duros.v2.ListClusterConfigParamsResponse
	156, // 306: lightbits.api.duros.v2.DurosAPI.RollbackVolume:output_type -> lightbits.api.duros.v2.RollbackVolumeResponse
	172, // 307: lightbits.api.duros.v2.DurosAPI.ListChangedBlocks:output_type -> lightbits.api.duros.v2.ListChangedBlocksResponse
	182, // 308: lightbits.api.duros.v2.DurosAPI.RotateClusterRootKey:output_type -> lightbits.api.duros.v2.RotateClusterRootKeyResponse
	184, // 309: lightbits.api.duros.v2.DurosAPI.GetClusterRootKey:output_type -> lightbits.api.duros.v2.GetClusterRootKeyResponse
	185, // 310: lightbits.api.duros.v2.DurosAPI.CreateIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	192, // 311: lightbits.api.duros.v2.DurosAPI.DeleteIdpConfiguration:output_type -> lightbits.api.duros.v2.DeleteIDPConfigurationResponse
	185, // 312: lightbits.api.duros.v2.DurosAPI.UpdateIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	189, // 313: lightbits.api.duros.v2.DurosAPI.ListIdpConfigurations:output_type -> lightbits.api.duros.v2.ListIDPConfigurationsResponse
	185, // 314: lightbits.api.duros.v2.DurosAPI.GetIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	193, // 315: lightbits.api.duros.v2.DurosAPI.CreateIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	198, // 316: lightbits.api.duros.v2.DurosAPI.DeleteIdpClientConf:output_type -> lightbits.api.duros.v2.DeleteIdpClientConfResponse
	193, // 317: lightbits.api.duros.v2.DurosAPI.UpdateIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	200, // 318: lightbits.api.duros.v2.DurosAPI.ListIdpClientConfs:output_type -> lightbits.api.duros.v2.ListIdpClientConfsResponse
	193, // 319: lightbits.api.duros.v2.DurosAPI.GetIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	201, // 320: lightbits.api.duros.v2.DurosAPI.CreateAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	201, // 321: lightbits.api.duros.v2.DurosAPI.UpdateAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	207, // 322: lightbits.api.duros.v2.DurosAPI.DeleteAuthMapEntry:output_type -> lightbits.api.duros.v2.DeleteAuthMapEntryResponse
	201, // 323: lightbits.api.duros.v2.DurosAPI.GetAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	208, // 324: lightbits.api.duros.v2.DurosAPI.ListAuthMapEntries:output_type -> lightbits.api.duros.v2.ListAuthMapEntriesResponse
	248, // 325: lightbits.api.duros.v2.DurosAPI.EnableClusterInBandAuth:output_type -> lightbits.api.duros.v2.EnableClusterInBandAuthResponse
	249, // 326: lightbits.api.duros.v2.DurosAPI.DisableClusterInBandAuth:output_type -> lightbits.api.duros.v2.DisableClusterInBandAuthResponse
	250, // 327: lightbits.api.duros.v2.DurosAPI.CreateTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	251, // 328: lightbits.api.duros.v2.DurosAPI.DeleteTrustedHost:output_type -> lightbits.api.duros.v2.DeleteTrustedHostResponse
	250, // 329: lightbits.api.duros.v2.DurosAPI.GetTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	252, // 330: lightbits.api.duros.v2.DurosAPI.ListTrustedHosts:output_type -> lightbits.api.duros.v2.ListTrustedHostsResponse
	250, // 331: lightbits.api.duros.v2.DurosAPI.UpdateTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	253, // 332: lightbits.api.duros.v2.DurosAPI.SetTrustedHostSecret:output_type -> lightbits.api.duros.v2.SetTrustedHostSecretsResponse
	254, // 333: lightbits.api.duros.v2.DurosAPI.GetTrustedHostSecret:output_type -> lightbits.api.duros.v2.GetTrustedHostSecretsResponse
	210, // 334: lightbits.api.duros.v2.DurosAPI.EnableFederatedAuthentication:output_type -> lightbits.api.duros.v2.EnableFederatedAuthenticationResponse
	212, // 335: lightbits.api.duros.v2.DurosAPI.DisableFederatedAuthentication:output_type -> lightbits.api.duros.v2.DisableFederatedAuthenticationResponse
	255, // 336: lightbits.api.duros.v2.DurosAPI.CFLogin:output_type -> lightbits.api.duros.v2.CFLoginResponse
	256, // 337: lightbits.api.duros.v2.DurosAPI.ListClusters:output_type -> lightbits.api.duros.v2.ListClustersResponse
	257, // 338: lightbits.api.duros.v2.DurosAPI.DetachCluster:output_type -> lightbits.api.duros.v2.DetachClusterResponse
	258, // 339: lightbits.api.duros.v2.DurosAPI.AttachCluster:output_type -> lightbits.api.duros.v2.AttachClusterResponse
	259, // 340: lightbits.api.duros.v2.DurosAPI.GetCFServiceCredentials:output_type -> lightbits.api.duros.v2.GetCFServiceCredentialsResponse
	260, // 341: lightbits.api.duros.v2.DurosAPI.ListWorkflows:output_type -> lightbits.api.duros.v2.ListWorkflowsResponse
	261, // 342: lightbits.api.duros.v2.DurosAPI.GetWorkflow:output_type -> lightbits.api.duros.v2.GetWorkflowResponse
	241, // [241:343] is the sub-list for method output_type
	139, // [139:241] is the sub-list for method input_type
