...
const (
	EnableClusterEncryptionRequest_unknown EnableClusterEncryptionRequest_KeyStore = 0
	EnableClusterEncryptionRequest_tpm     EnableClusterEncryptionRequest_KeyStore = 1
	EnableClusterEncryptionRequest_file    EnableClusterEncryptionRequest_KeyStore = 2
)
...
type AuthMapEntry_StateEnum int32

const (
	AuthMapEntry_Unknown   AuthMapEntry_StateEnum = 0
	AuthMapEntry_Creating  AuthMapEntry_StateEnum = 1
	AuthMapEntry_Available AuthMapEntry_StateEnum = 2
	AuthMapEntry_Deleting  AuthMapEntry_StateEnum = 3
	AuthMapEntry_Updating  AuthMapEntry_StateEnum = 4
	AuthMapEntry_Failed    AuthMapEntry_StateEnum = 5
)

// Enum value maps for AuthMapEntry_StateEnum.
var (
	AuthMapEntry_StateEnum_name = map[int32]string{
		0: "Unknown",
		1: "Creating",
		2: "Available",
		3: "Deleting",
	...
	AuthMapEntry_StateEnum_value = map[string]int32{
		"Unknown":   0,
		"Creating":  1,
		"Available": 2,
		"Deleting":  3,
...
func (x AuthMapEntry_StateEnum) Enum() *AuthMapEntry_StateEnum {
	p := new(AuthMapEntry_StateEnum)
	*p = x
	return p
}

func (x AuthMapEntry_StateEnum) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AuthMapEntry_StateEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_lightbits_api_duros_v2_durosapiv2_proto_enumTypes[31].Descriptor()
}

func (AuthMapEntry_StateEnum) Type() protoreflect.EnumType {
	return &file_lightbits_api_duros_v2_durosapiv2_proto_enumTypes[31]
}

func (x AuthMapEntry_StateEnum) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AuthMapEntry_StateEnum.Descriptor instead.
func (AuthMapEntry_StateEnum) EnumDescriptor() ([]byte, []int) {
	return file_lightbits_api_duros_v2_durosapiv2_proto_rawDescGZIP(), []int{165, 0}
}
...
func (x *EnableClusterEncryptionRequest) GetKeyStore() EnableClusterEncryptionRequest_KeyStore {
	...
	return EnableClusterEncryptionRequest_unknown
}
...
type GetClusterRootKeyRequest struct {
	...
	//
	// The Generation key you want to export.
...
type GetClusterRootKeyResponse struct {
	...
	// clusterPublicKey
	//
	// The public key you should save in order to encrypt the key when you need to import it back to the cluster
...
type IDPConfiguration struct {
	...
	// ProxyInfo
	//
	// Optional. Proxy server information for idp behind proxy.
...
type CreateIDPConfigurationRequest struct {
	...
	//
	// Optional. Proxy server information for idp behind proxy.
	// Proxy support for IdP: currently only supports insecure access, Username and Password should not be used.
	ProxyInfo *ProxyInfo `protobuf:"bytes,4,opt,name=ProxyInfo,proto3" json:"ProxyInfo,omitempty"`
}
...
// idp-client-configuration represents a configuration for idp-client
// in LB cluster.
type IdpClientConf struct {
	...
	// name
	//
	// a unique name for the idp-client-conf.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// clientId
	//
	// unique client ID identifier registered in the IdP to identify a
	// specific application (or a client) that wants to access resources
	// from Lightbits cluster.
	ClientId string `protobuf:"bytes,3,opt,name=clientId,proto3" json:"clientId,omitempty"`
	// idpConfName
	//
	// a reference to the IdP configuration that will use this this client
	// configuration.
	IdpConfName string `protobuf:"bytes,4,opt,name=idpConfName,proto3" json:"idpConfName,omitempty"`
	// userClaimName
	//
	// when working in user authorization mode, the user claim name specifies
	// the name of the field in JWT claim from which to extract the identifier
	// value from.
	// Note, this field is only required when authzMode=user.
	UserClaimName string `protobuf:"bytes,5,opt,name=userClaimName,proto3" json:"userClaimName,omitempty"`
	// authzMode
	//
	// the authorization mode determines whether it's a user authorization or
...
func (x *IdpClientConf) GetUserClaimName() string {
	if x != nil {
		return x.UserClaimName
	}
	return ""
}
...
type CreateIdpClientConfRequest struct {
	...
	// value from.
	// Note, this field is only required when authzMode=user.
	UserClaimName string `protobuf:"bytes,4,opt,name=userClaimName,proto3" json:"userClaimName,omitempty"`
	// authzMode
	//
	// the authorization mode determines whether it's a user authorization or
	// application authorization.
...
func (x *CreateIdpClientConfRequest) GetUserClaimName() string {
	if x != nil {
		return x.UserClaimName
	}
	return ""
...
type UpdateIdpClientConfRequest struct {
	...
	// value from.
	// Note, this field is only required when authzMode=user.
	UserClaimName string `protobuf:"bytes,2,opt,name=userClaimName,proto3" json:"userClaimName,omitempty"`
}
...
func (x *UpdateIdpClientConfRequest) GetUserClaimName() string {
	if x != nil {
		return x.UserClaimName
	}
	return ""
...
type AuthMapEntry struct {
	...
	// State
	// AuthMapEntry state
	State AuthMapEntry_StateEnum `protobuf:"varint,1,opt,name=state,proto3,enum=lightbits.api.duros.v2.AuthMapEntry_StateEnum" json:"state,omitempty"`
	// UUID
	// AuthMapEntry UUID
	UUID string `protobuf:"bytes,2,opt,name=UUID,proto3" json:"UUID,omitempty"`
	// Name
	// Name of specific authorisation mapping entry.
	Name string `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	// Identifier
	// Identifier to map application or group to Lightbits scope/role
	// when using authMode=app this field should specify an identifier
	// of the clientID of the relevant application. if using authMode=user
	// this should specify a group name.
	...
	// AuthorizationMode
	// Represents the authorisation mode for the clientID
	AuthzMode AuthorizationMode `protobuf:"varint,7,opt,name=authzMode,proto3,enum=lightbits.api.duros.v2.AuthorizationMode" json:"authzMode,omitempty"`
	// idpConfigurationName
	// idp configuration that is associated with this authorisation map entry.
	IdpConfigurationName string `protobuf:"bytes,8,opt,name=idpConfigurationName,proto3" json:"idpConfigurationName,omitempty"`
}
...
func (x *AuthMapEntry) GetState() AuthMapEntry_StateEnum {
	if x != nil {
		return x.State
	}
	return AuthMapEntry_Unknown
}
...
func (x *AuthMapEntry) GetAuthzMode() AuthorizationMode {
	if x != nil {
		return x.AuthzMode
	}
	return AuthorizationMode_UnknownAuthzMode
...
type CreateAuthMapEntryRequest struct {
	...
	// idpConfigurationName
	// idp configuration that is associated with this authorisation map entry.
	IdpConfigurationName string `protobuf:"bytes,6,opt,name=idpConfigurationName,proto3" json:"idpConfigurationName,omitempty"`
}
...
func (x *CreateAuthMapEntryRequest) GetAuthzMode() AuthorizationMode {
	if x != nil {
		return x.AuthzMode
	}
	return AuthorizationMode_UnknownAuthzMode
...
type UpdateAuthMapEntryRequest struct {
	...
	// AuthorizationMode
	// Represents the authorisation mode for the clientID
	AuthzMode AuthorizationMode `protobuf:"varint,4,opt,name=authzMode,proto3,enum=lightbits.api.duros.v2.AuthorizationMode" json:"authzMode,omitempty"`
	// Identifier
	// Identifier to map application or group to Lightbits scope/role
	// when using authMode=app this field should specify an identifier
	// of the clientID of the relevant application. if using authMode=user
...
func (x *UpdateAuthMapEntryRequest) GetAuthzMode() AuthorizationMode {
	if x != nil {
		return x.AuthzMode
	}
	return AuthorizationMode_UnknownAuthzMode
...
var file_lightbits_api_duros_v2_durosapiv2_proto_rawDesc = []byte{
	...
	0x78, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xa9, 0x01, 0x0a, 0x1e, 0x45, 0x6e, 0x61, 0x62, 0x6c,
	...
	0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x22, 0x2a, 0x0a, 0x08, 0x4b, 0x65, 0x79, 0x53, 0x74, 0x6f,
	0x72, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x10, 0x00, 0x12,
	0x07, 0x0a, 0x03, 0x74, 0x70, 0x6d, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65,
	0x10, 0x02, 0x22, 0x13, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0xd7, 0x01,
	...
	0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x69, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01,
	...
	0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74,
	0x79, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74,
	0x79, 0x12, 0x24, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e,
	0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0x69, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x45,
	...
	0x72, 0x6f, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x65, 0x76,
	...
	0x65, 0x6e, 0x22, 0x5c, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x55, 0x55, 0x49, 0x44, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x55, 0x55, 0x49, 0x44, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x20,
	0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20,
	...
	0x52, 0x04, 0x55, 0x55, 0x49, 0x44, 0x22, 0xf7, 0x01, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x56,
	...
	,
	...
	0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x12, 0x1e, 0x0a, 0x0a, 0x73, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x55, 0x55, 0x49, 0x44, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x55, 0x55, 0x49, 0x44, 0x12, 0x4f, 0x0a, 0x05, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x39, 0x2e, 0x6c, 0x69, 0x67, 0x68,
	...
	,
	...
	0x22, 0x21, 0x0a, 0x1f, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x15, 0x0a, 0x13, 0x52, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x4e, 0x6f,
	0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x16, 0x0a, 0x14, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0
 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x75, 0x72, 0x6f, 0x73,
	...
	,
	...
	0x65, 0x64, 0x2e, 0x12, 0x06, 0x0a, 0x04, 0x9a, 0x02, 0x01, 0x03, 0x4a, 0x38, 0x0a, 0x03, 0x34,
	0x30, 0x34, 0x12, 0x31, 0x0a, 0x27, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x20, 0x77, 0x69, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x03, 0x4a, 0x30, 0x0a, 0x03, 0x34, 0x30, 0x34, 0x12, 0x29, 0x0a, 0x1f, 0x50, 0x72, 0x6f,
	0x76, 0x69, 0x64, 0x65, 0x64, 0x20, 0x68, 0x6f, 0x73, 0x74, 0x20, 0x4e, 0x51, 0x4e, 0x20, 0x69,
	...
	,
	...
	,
	...
	0x30, 0x34, 0x12, 0x2c, 0x0a, 0x22, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x64, 0x20, 0x76,
	0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x20, 0x55, 0x55, 0x49, 0x44, 0x20, 0x69, 0x73, 0x20, 0x6e, 0x6f,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x49, 0x5a, 0x18, 0x12, 0x16, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32,
	...
	0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x2f, 0x7b, 0x55, 0x55, 0x49, 0x44, 0x7d, 0x12, 0x82,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x01, 0x03, 0x4a, 0x28, 0x0a, 0x03, 0x34, 0x30, 0x34, 0x12, 0x21, 0x0a, 0x17, 0x4e, 0x6f,
	0x64, 0x65, 0x20, 0x55, 0x55, 0x49, 0x44, 0x20, 0x69, 0x73, 0x20, 0x6e, 0x6f, 0x74, 0x20, 0x66,
	...
	,
	...
	,
	...
	,
	...
	0x93, 0x02, 0x0e, 0x12, 0x0c, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x6c, 0x6f, 0x67,
	0x73, 0x30, 0x01, 0x12, 0x83, 0x03, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74,
	...
	0x66, 0x6f, 0x22, 0xa4, 0x02, 0x92, 0x41, 0x89, 0x02, 0x0a, 0x0b, 0x67, 0x65, 0x74, 0x20, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x20, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x06, 0x0a, 0x04, 0x9a, 0x02, 0x01, 0x03, 0x4a,
	...
	0x65, 0x72, 0x69, 0x61, 0x6c, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x7d, 0x12, 0x8d, 0x07, 0x0a,
	...
	0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9e, 0x06, 0x92, 0x41,
	0xfc, 0x05, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x1a, 0x41, 0x64, 0x64, 0x20, 0x4e, 0x56,
	...
	0x61, 0x6c, 0x20, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x20, 0x6f, 0x66, 0x20, 0x4c, 0x69, 0x67, 0x68,
	0x74, 0x62, 0x69, 0x74, 0x73, 0x2e, 0x12, 0x06, 0x0a, 0x04, 0x9a, 0x02, 0x01, 0x03, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x18, 0x3a, 0x01, 0x2a, 0x22, 0x13, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32,
	0x2f, 0x6e, 0x76, 0x6d, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0xf2, 0x06, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x65, 0x64, 0x2e, 0x12, 0x06, 0x0a, 0x04, 0x9a, 0x02, 0x01, 0x03, 0x4a, 0x3a, 0x0a, 0x03,
	...
	0x55, 0x55, 0x49, 0x44, 0x7d, 0x12, 0x98, 0x04, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x73, 0x12, 0x2a, 0x2e, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x62, 0x69, 0x74,
	0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0
 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1f, 0x12, 0x1d, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x76, 0x32, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69,
	0x6e, 0x74, 0x73, 0x2f, 0x7b, 0x70, 0x6f, 0x72, 0x74, 0x7d, 0x12, 0xda, 0x04, 0x0a, 0x14, 0x43,
	...
	0x22, 0xe4, 0x03, 0x92, 0x41, 0xa6, 0x03, 0x0a, 0x16, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x20,
	...
	0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0xe1, 0x04, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61,
	...
	,
	...
	,
	...
	0x76, 0x32, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0xd4, 0x04, 0x0a, 0x0c,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x2b, 0x2e, 0x6c,
	0x69, 0x67, 0x68, 0x74, 0x62, 0x69, 0x74, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x75, 0x72,
	...
	,
	...
	0x44, 0x7d, 0x12, 0x97, 0x05, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x33, 0x2e, 0x6c, 0x69,
	0x67, 0x68, 0x74, 0x62, 0x69, 0x74, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x75, 0x72, 0x6f,
	0x73, 0x2e, 0x76, 0x32, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x93, 0x04, 0x92, 0x41, 0xce, 0x03, 0x0a, 0x16, 0x75,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x20, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x20, 0x70,
	...
	,
	...
	0x6d, 0x65, 0x20, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x73, 0x20, 0x69, 0x6c, 0x6c, 0x65,
	0x67, 0x61, 0x6c, 0x20, 0x63, 0x68, 0x61, 0x72, 0x61, 0x63, 0x74, 0x65, 0x72, 0x73, 0x2c, 0x20,
	0x0a, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x20, 0x61, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e,
	0x74, 0x20, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2e, 0x12, 0x06, 0x0a, 0x04, 0x9a, 0x02, 0x01, 0x03,
	...
	0x3b, 0x3a, 0x01, 0x2a, 0x1a, 0x36, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x72,
	...
	,
	...
	0x12, 0x17, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69,
	0x65, 0x73, 0x2f, 0x7b, 0x55, 0x55, 0x49, 0x44, 0x7d, 0x12, 0x8c, 0x03, 0x0a, 0x0c, 0x4c, 0x69,
	0x73, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0x2b, 0x2e, 0x6c, 0x69, 0x67,
	0x68, 0x74, 0x62, 0x69, 0x74, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x75, 0x72, 0x6f, 0x73,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa0, 0x02, 0x92, 0x41, 0x84, 0x02, 0x0a, 0x0d, 0x6c, 0x69,
	...
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0xe7, 0x03, 0x0a, 0x14, 0x4c, 0x69, 0x73,
	...
	,
	...
	,
	...
	0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xcc, 0x02, 0x92,
	0x41, 0x8a, 0x02, 0x0a, 0x16, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x20, 0x72, 0x65, 0x73, 0x6f,
	...
	0x6c, 0x20, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x20, 0x6f, 0x66, 0x20, 0x4c, 0x69, 0x67, 0x68, 0x74,
	0x62, 0x69, 0x74, 0x73, 0x2e, 0x12, 0x06, 0x0a, 0x04, 0x9a, 0x02, 0x01, 0x03, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x38, 0x2a, 0x36, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x7b, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0
 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74,
	...
	0x1a, 0xea, 0x04, 0x53, 0x65, 0x74, 0x20, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x20, 0x73, 0x65, 0x63,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x7d, 0x42, 0x0d, 0x5a, 0x0b, 0x64, 0x75, 0x72, 0x6f, 0x73, 0x2f, 0x76, 0x32, 0x3b, 0x76, 0x32,
...
var file_lightbits_api_duros_v2_durosapiv2_proto_enumTypes = make([]protoimpl.EnumInfo, 32)
var file_lightbits_api_duros_v2_durosapiv2_proto_msgTypes = make([]protoimpl.MessageInfo, 179)
var file_lightbits_api_duros_v2_durosapiv2_proto_goTypes = []any{
	...
	(EnableClusterEncryptionRequest_KeyStore)(0), // 7: lightbits.api.duros.v2.EnableClusterEncryptionRequest.KeyStore
	(UserNvmeDevicesResponse_StateEnum)(0),       // 8: lightbits.api.duros.v2.UserNvmeDevicesResponse.StateEnum
	...
	(ClusterLastUpgrade_UpgradeStatusEnum)(0),    // 11: lightbits.api.duros.v2.ClusterLastUpgrade.UpgradeStatusEnum
	(ClusterInfo_AuthenticationMode)(0),          // 12: lightbits.api.duros.v2.ClusterInfo.AuthenticationMode
	(ClusterHealth_State)(0),                     // 13: lightbits.api.duros.v2.ClusterHealth.State
	(Volume_StateEnum)(0),                        // 14: lightbits.api.duros.v2.Volume.StateEnum
	(Volume_ProtocolEnum)(0),                     // 15: lightbits.api.duros.v2.Volume.ProtocolEnum
	(ServerEvictionStatus_StatusEnum)(0),         // 16: lightbits.api.duros.v2.ServerEvictionStatus.StatusEnum
	(ServerLastUpgrade_UpgradeStatusEnum)(0),     // 17: lightbits.api.duros.v2.ServerLastUpgrade.UpgradeStatusEnum
	(Server_UpgradeStatusEnum)(0),                // 18: lightbits.api.duros.v2.Server.UpgradeStatusEnum
	(Server_RiskOfServiceLossEnum)(0),            // 19: lightbits.api.duros.v2.Server.RiskOfServiceLossEnum
	(Server_ServerStateEnum)(0),                  // 20: lightbits.api.duros.v2.Server.ServerStateEnum
	(Snapshot_StateEnum)(0),                      // 21: lightbits.api.duros.v2.Snapshot.StateEnum
	(ResourcePolicy_State)(0),                    // 22: lightbits.api.duros.v2.ResourcePolicy.State
	(Policy_State)(0),                            // 23: lightbits.api.duros.v2.Policy.State
	(LabelValueKeyPair_Key)(0),                   // 24: lightbits.api.duros.v2.LabelValueKeyPair.Key
	(LabelMatchExpression_Operator)(0),           // 25: lightbits.api.duros.v2.LabelMatchExpression.Operator
	(Event_EventType)(0),                         // 26: lightbits.api.duros.v2.Event.EventType
	(Event_EventReportingService)(0),             // 27: lightbits.api.duros.v2.Event.EventReportingService
	(Event_EventSeverity)(0),                     // 28: lightbits.api.duros.v2.Event.EventSeverity
	(ClusterEncryptionStatus_State)(0),           // 29: lightbits.api.duros.v2.ClusterEncryptionStatus.State
	(IDPConfiguration_IDPConfigurationState)(0),  // 30: lightbits.api.duros.v2.IDPConfiguration.IDPConfigurationState
	(AuthMapEntry_StateEnum)(0),                  // 31: lightbits.api.duros.v2.AuthMapEntry.StateEnum
	(*LogRequest)(nil),                           // 32: lightbits.api.duros.v2.LogRequest
	(*AdminEndpoint)(nil),                        // 33: lightbits.api.duros.v2.AdminEndpoint
	(*GetAdminEndpointRequest)(nil),              // 34: lightbits.api.duros.v2.GetAdminEndpointRequest
	(*ListAdminEndpointsResponse)(nil),           // 35: lightbits.api.duros.v2.ListAdminEndpointsResponse
	(*ListAdminEndpointsRequest)(nil),            // 36: lightbits.api.duros.v2.ListAdminEndpointsRequest
	(*CreateAdminEndpointRequest)(nil),           // 37: lightbits.api.duros.v2.CreateAdminEndpointRequest
	(*UpdateAdminEndpointRequest)(nil),           // 38: lightbits.api.duros.v2.UpdateAdminEndpointRequest
	(*DeleteAdminEndpointRequest)(nil),           // 39: lightbits.api.duros.v2.DeleteAdminEndpointRequest
	(*DeleteAdminEndpointResponse)(nil),          // 40: lightbits.api.duros.v2.DeleteAdminEndpointResponse
	(*CreateCredentialRequest)(nil),              // 41: lightbits.api.duros.v2.CreateCredentialRequest
	(*Credential)(nil),                           // 42: lightbits.api.duros.v2.Credential
	(*DeleteCredentialRequest)(nil),              // 43: lightbits.api.duros.v2.DeleteCredentialRequest
	(*DeleteCredentialResponse)(nil),             // 44: lightbits.api.duros.v2.DeleteCredentialResponse
	(*ListCredentialsRequest)(nil),               // 45: lightbits.api.duros.v2.ListCredentialsRequest
	(*ListCredentialsResponse)(nil),              // 46: lightbits.api.duros.v2.ListCredentialsResponse
	(*GetCredentialRequest)(nil),                 // 47: lightbits.api.duros.v2.GetCredentialRequest
	(*DefaultPolicy)(nil),                        // 48: lightbits.api.duros.v2.DefaultPolicy
	(*CreateProjectRequest)(nil),                 // 49: lightbits.api.duros.v2.CreateProjectRequest
	(*Project)(nil),                              // 50: lightbits.api.duros.v2.Project
	(*DeleteProjectRequest)(nil),                 // 51: lightbits.api.duros.v2.DeleteProjectRequest
	(*DeleteProjectResponse)(nil),                // 52: lightbits.api.duros.v2.DeleteProjectResponse
	(*ListProjectsRequest)(nil),                  // 53: lightbits.api.duros.v2.ListProjectsRequest
	(*ListProjectsResponse)(nil),                 // 54: lightbits.api.duros.v2.ListProjectsResponse
	(*GetProjectRequest)(nil),                    // 55: lightbits.api.duros.v2.GetProjectRequest
	(*StringList)(nil),                           // 56: lightbits.api.duros.v2.StringList
	(*GetVersionRequest)(nil),                    // 57: lightbits.api.duros.v2.GetVersionRequest
	(*CreateVolumeRequest)(nil),                  // 58: lightbits.api.duros.v2.CreateVolumeRequest
	(*DeleteVolumeRequest)(nil),                  // 59: lightbits.api.duros.v2.DeleteVolumeRequest
	(*DeleteVolumeResponse)(nil),                 // 60: lightbits.api.duros.v2.DeleteVolumeResponse
	(*EnableServerRequest)(nil),                  // 61: lightbits.api.duros.v2.EnableServerRequest
	(*DisableServerRequest)(nil),                 // 62: lightbits.api.duros.v2.DisableServerRequest
	(*DeleteServerRequest)(nil),                  // 63: lightbits.api.duros.v2.DeleteServerRequest
	(*ReplaceNodeRequest)(nil),                   // 64: lightbits.api.duros.v2.ReplaceNodeRequest
	(*CreateServerRequest)(nil),                  // 65: lightbits.api.duros.v2.CreateServerRequest
	(*UpdateVolumeRequest)(nil),                  // 66: lightbits.api.duros.v2.UpdateVolumeRequest
	(*UpgradeServerRequest)(nil),                 // 67: lightbits.api.duros.v2.UpgradeServerRequest
	(*UpgradeClusterRequest)(nil),                // 68: lightbits.api.duros.v2.UpgradeClusterRequest
	(*EnableClusterEncryptionRequest)(nil),       // 69: lightbits.api.duros.v2.EnableClusterEncryptionRequest
	(*GetClusterRequest)(nil),                    // 70: lightbits.api.duros.v2.GetClusterRequest
	(*UpdateNvmeDeviceRequest)(nil),              // 71: lightbits.api.duros.v2.UpdateNvmeDeviceRequest
	(*AddNvmeDeviceRequest)(nil),                 // 72: lightbits.api.duros.v2.AddNvmeDeviceRequest
	(*GetHostRequest)(nil),                       // 73: lightbits.api.duros.v2.GetHostRequest
	(*ListHostsRequest)(nil),                     // 74: lightbits.api.duros.v2.ListHostsRequest
	(*ListHostsResponse)(nil),                    // 75: lightbits.api.duros.v2.ListHostsResponse
	(*ListNodeRequest)(nil),                      // 76: lightbits.api.duros.v2.ListNodeRequest
	(*ListEventsRequest)(nil),                    // 77: lightbits.api.duros.v2.ListEventsRequest
	(*ListEventsResponse)(nil),                   // 78: lightbits.api.duros.v2.ListEventsResponse
	(*GetVolumeRequest)(nil),                     // 79: lightbits.api.duros.v2.GetVolumeRequest
	(*GetNodeRequest)(nil),                       // 80: lightbits.api.duros.v2.GetNodeRequest
	(*ListVolumeRequest)(nil),                    // 81: lightbits.api.duros.v2.ListVolumeRequest
	(*ListNvmeDevicesRequest)(nil),               // 82: lightbits.api.duros.v2.ListNvmeDevicesRequest
	(*GetNvmeDeviceRequest)(nil),                 // 83: lightbits.api.duros.v2.GetNvmeDeviceRequest
	(*ListNvmeDevicesResponse)(nil),              // 84: lightbits.api.duros.v2.ListNvmeDevicesResponse
	(*ConnectedHost)(nil),                        // 85: lightbits.api.duros.v2.ConnectedHost
	(*UserNvmeDevicesResponse)(nil),              // 86: lightbits.api.duros.v2.UserNvmeDevicesResponse
	(*DurosNodeInfo)(nil),                        // 87: lightbits.api.duros.v2.DurosNodeInfo
	(*ListNodesResponse)(nil),                    // 88: lightbits.api.duros.v2.ListNodesResponse
	(*ListVolumesResponse)(nil),                  // 89: lightbits.api.duros.v2.ListVolumesResponse
	(*UpdateNvmeDeviceResponse)(nil),             // 90: lightbits.api.duros.v2.UpdateNvmeDeviceResponse
	(*AddNvmeDeviceResponse)(nil),                // 91: lightbits.api.duros.v2.AddNvmeDeviceResponse
	(*UpdateVolumeResponse)(nil),                 // 92: lightbits.api.duros.v2.UpdateVolumeResponse
	(*UpgradeServerResponse)(nil),                // 93: lightbits.api.duros.v2.UpgradeServerResponse
	(*UpgradeClusterResponse)(nil),               // 94: lightbits.api.duros.v2.UpgradeClusterResponse
	(*EnableClusterEncryptionResponse)(nil),      // 95: lightbits.api.duros.v2.EnableClusterEncryptionResponse
	(*ReplaceNodeResponse)(nil),                  // 96: lightbits.api.duros.v2.ReplaceNodeResponse
	(*DeleteServerResponse)(nil),                 // 97: lightbits.api.duros.v2.DeleteServerResponse
	(*DisableServerResponse)(nil),                // 98: lightbits.api.duros.v2.DisableServerResponse
	(*ListServersRequest)(nil),                   // 99: lightbits.api.duros.v2.ListServersRequest
	(*GetServerRequest)(nil),                     // 100: lightbits.api.duros.v2.GetServerRequest
	(*ListServersResponse)(nil),                  // 101: lightbits.api.duros.v2.ListServersResponse
	(*ClusterUpgradeStatusResponse)(nil),         // 102: lightbits.api.duros.v2.ClusterUpgradeStatusResponse
	(*ListUpgradeStatusResponse)(nil),            // 103: lightbits.api.duros.v2.ListUpgradeStatusResponse
	(*Version)(nil),                              // 104: lightbits.api.duros.v2.Version
	(*ClusterLastUpgrade)(nil),                   // 105: lightbits.api.duros.v2.ClusterLastUpgrade
	(*ClusterInfo)(nil),                          // 106: lightbits.api.duros.v2.ClusterInfo
	(*ClusterInfoV2)(nil),                        // 107: lightbits.api.duros.v2.ClusterInfoV2
	(*ClusterHealth)(nil),                        // 108: lightbits.api.duros.v2.ClusterHealth
	(*Volume)(nil),                               // 109: lightbits.api.duros.v2.Volume
	(*ServerEvictionStatus)(nil),                 // 110: lightbits.api.duros.v2.ServerEvictionStatus
	(*ServerLastUpgrade)(nil),                    // 111: lightbits.api.duros.v2.ServerLastUpgrade
	(*Server)(nil),                               // 112: lightbits.api.duros.v2.Server
	(*GetRoleRequest)(nil),                       // 113: lightbits.api.duros.v2.GetRoleRequest
	(*GetRoleResponse)(nil),                      // 114: lightbits.api.duros.v2.GetRoleResponse
	(*Role)(nil),                                 // 115: lightbits.api.duros.v2.Role
	(*ListRolesRequest)(nil),                     // 116: lightbits.api.duros.v2.ListRolesRequest
	(*ListRolesResponse)(nil),                    // 117: lightbits.api.duros.v2.ListRolesResponse
	(*Snapshot)(nil),                             // 118: lightbits.api.duros.v2.Snapshot
	(*DeleteSnapshotRequest)(nil),                // 119: lightbits.api.duros.v2.DeleteSnapshotRequest
	(*CreateSnapshotRequest)(nil),                // 120: lightbits.api.duros.v2.CreateSnapshotRequest
	(*ListSnapshotsRequest)(nil),                 // 121: lightbits.api.duros.v2.ListSnapshotsRequest
	(*GetSnapshotRequest)(nil),                   // 122: lightbits.api.duros.v2.GetSnapshotRequest
	(*ListSnapshotsResponse)(nil),                // 123: lightbits.api.duros.v2.ListSnapshotsResponse
	(*DeleteSnapshotResponse)(nil),               // 124: lightbits.api.duros.v2.DeleteSnapshotResponse
	(*FeatureFlagStatus)(nil),                    // 125: lightbits.api.duros.v2.FeatureFlagStatus
	(*GetFeatureFlagRequest)(nil),                // 126: lightbits.api.duros.v2.GetFeatureFlagRequest
	(*EnableFeatureFlagRequest)(nil),             // 127: lightbits.api.duros.v2.EnableFeatureFlagRequest
	(*DisableFeatureFlagRequest)(nil),            // 128: lightbits.api.duros.v2.DisableFeatureFlagRequest
	(*SetFeatureFlagResponse)(nil),               // 129: lightbits.api.duros.v2.SetFeatureFlagResponse
	(*ListFeatureFlagsRequest)(nil),              // 130: lightbits.api.duros.v2.ListFeatureFlagsRequest
	(*ListFeatureFlagsResponse)(nil),             // 131: lightbits.api.duros.v2.ListFeatureFlagsResponse
	(*CreateResourcePolicyRequest)(nil),          // 132: lightbits.api.duros.v2.CreateResourcePolicyRequest
	(*CreatePolicyRequest)(nil),                  // 133: lightbits.api.duros.v2.CreatePolicyRequest
	(*UpdatePolicyRequest)(nil),                  // 134: lightbits.api.duros.v2.UpdatePolicyRequest
	(*UpdatePolicyResponse)(nil),                 // 135: lightbits.api.duros.v2.UpdatePolicyResponse
	(*ResourcePolicy)(nil),                       // 136: lightbits.api.duros.v2.ResourcePolicy
	(*Policy)(nil),                               // 137: lightbits.api.duros.v2.Policy
	(*UpdateResourcePolicyRequest)(nil),          // 138: lightbits.api.duros.v2.UpdateResourcePolicyRequest
	(*UpdateResourcePolicyResponse)(nil),         // 139: lightbits.api.duros.v2.UpdateResourcePolicyResponse
	(*ListPoliciesRequest)(nil),                  // 140: lightbits.api.duros.v2.ListPoliciesRequest
	(*ListPoliciesResponse)(nil),                 // 141: lightbits.api.duros.v2.ListPoliciesResponse
	(*ListResourcePoliciesRequest)(nil),          // 142: lightbits.api.duros.v2.ListResourcePoliciesRequest
	(*ListResourcePoliciesResponse)(nil),         // 143: lightbits.api.duros.v2.ListResourcePoliciesResponse
	(*GetPolicyRequest)(nil),                     // 144: lightbits.api.duros.v2.GetPolicyRequest
	(*GetResourcePolicyRequest)(nil),             // 145: lightbits.api.duros.v2.GetResourcePolicyRequest
	(*DeleteResourcePolicyRequest)(nil),          // 146: lightbits.api.duros.v2.DeleteResourcePolicyRequest
	(*DeleteResourcePolicyResponse)(nil),         // 147: lightbits.api.duros.v2.DeleteResourcePolicyResponse
	(*DeletePolicyRequest)(nil),                  // 148: lightbits.api.duros.v2.DeletePolicyRequest
	(*DeletePolicyResponse)(nil),                 // 149: lightbits.api.duros.v2.DeletePolicyResponse
	(*GetClusterConfigParamRequest)(nil),         // 150: lightbits.api.duros.v2.GetClusterConfigParamRequest
	(*ClusterConfigParam)(nil),                   // 151: lightbits.api.duros.v2.ClusterConfigParam
	(*UpdateClusterConfigParamRequest)(nil),      // 152: lightbits.api.duros.v2.UpdateClusterConfigParamRequest
	(*RollbackVolumeRequest)(nil),                // 153: lightbits.api.duros.v2.RollbackVolumeRequest
	(*RollbackVolumeResponse)(nil),               // 154: lightbits.api.duros.v2.RollbackVolumeResponse
	(*UpdateClusterConfigParamResponse)(nil),     // 155: lightbits.api.duros.v2.UpdateClusterConfigParamResponse
	(*ListClusterConfigParamsRequest)(nil),       // 156: lightbits.api.duros.v2.ListClusterConfigParamsRequest
	(*ListClusterConfigParamsResponse)(nil),      // 157: lightbits.api.duros.v2.ListClusterConfigParamsResponse
	(*LabelValueKeyPair)(nil),                    // 158: lightbits.api.duros.v2.LabelValueKeyPair
	(*LabelMatchExpression)(nil),                 // 159: lightbits.api.duros.v2.LabelMatchExpression
	(*ComponentVolumeInfo)(nil),                  // 160: lightbits.api.duros.v2.ComponentVolumeInfo
	(*VolumeComponentInfoList)(nil),              // 161: lightbits.api.duros.v2.VolumeComponentInfoList
	(*ComponentVolumesInfo)(nil),                 // 162: lightbits.api.duros.v2.ComponentVolumesInfo
	(*ComponentNodeInfo)(nil),                    // 163: lightbits.api.duros.v2.ComponentNodeInfo
	(*ComponentClusterInfo)(nil),                 // 164: lightbits.api.duros.v2.ComponentClusterInfo
	(*ComponentNVMeSSDInfo)(nil),                 // 165: lightbits.api.duros.v2.ComponentNVMeSSDInfo
	(*ComponentServerInfo)(nil),                  // 166: lightbits.api.duros.v2.ComponentServerInfo
	(*ComponentDataIntegrityInfo)(nil),           // 167: lightbits.api.duros.v2.ComponentDataIntegrityInfo
	(*LBARange)(nil),                             // 168: lightbits.api.duros.v2.LBARange
	(*ListChangedBlocksRequest)(nil),             // 169: lightbits.api.duros.v2.ListChangedBlocksRequest
	(*ListChangedBlocksResponse)(nil),            // 170: lightbits.api.duros.v2.ListChangedBlocksResponse
	(*Event)(nil),                                // 171: lightbits.api.duros.v2.Event
	(*QoSRateLimitPolicy)(nil),                   // 172: lightbits.api.duros.v2.QoSRateLimitPolicy
	(*DefaultGlobalResourcePolicy)(nil),          // 173: lightbits.api.duros.v2.DefaultGlobalResourcePolicy
	(*UpdateProjectRequest)(nil),                 // 174: lightbits.api.duros.v2.UpdateProjectRequest
	(*UpdateProjectResponse)(nil),                // 175: lightbits.api.duros.v2.UpdateProjectResponse
	(*ClusterEncryptionStatus)(nil),              // 176: lightbits.api.duros.v2.ClusterEncryptionStatus
	(*RotateClusterRootKeyRequest)(nil),          // 177: lightbits.api.duros.v2.RotateClusterRootKeyRequest
	(*RotateClusterRootKeyResponse)(nil),         // 178: lightbits.api.duros.v2.RotateClusterRootKeyResponse
	(*GetClusterRootKeyRequest)(nil),             // 179: lightbits.api.duros.v2.GetClusterRootKeyRequest
	(*GetClusterRootKeyResponse)(nil),            // 180: lightbits.api.duros.v2.GetClusterRootKeyResponse
	(*IDPConfiguration)(nil),                     // 181: lightbits.api.duros.v2.IDPConfiguration
	(*CreateIDPConfigurationRequest)(nil),        // 182: lightbits.api.duros.v2.CreateIDPConfigurationRequest
	(*UpdateIDPConfigurationRequest)(nil),        // 183: lightbits.api.duros.v2.UpdateIDPConfigurationRequest
	(*ListIDPConfigurationsRequest)(nil),         // 184: lightbits.api.duros.v2.ListIDPConfigurationsRequest
	(*ListIDPConfigurationsResponse)(nil),        // 185: lightbits.api.duros.v2.ListIDPConfigurationsResponse
	(*GetIDPConfigurationRequest)(nil),           // 186: lightbits.api.duros.v2.GetIDPConfigurationRequest
	(*DeleteIDPConfigurationRequest)(nil),        // 187: lightbits.api.duros.v2.DeleteIDPConfigurationRequest
	(*DeleteIDPConfigurationResponse)(nil),       // 188: lightbits.api.duros.v2.DeleteIDPConfigurationResponse
	(*IdpClientConf)(nil),                        // 189: lightbits.api.duros.v2.IdpClientConf
	(*CreateIdpClientConfRequest)(nil),           // 190: lightbits.api.duros.v2.CreateIdpClientConfRequest
	(*UpdateIdpClientConfRequest)(nil),           // 191: lightbits.api.duros.v2.UpdateIdpClientConfRequest
	(*GetIdpClientConfRequest)(nil),              // 192: lightbits.api.duros.v2.GetIdpClientConfRequest
	(*DeleteIdpClientConfRequest)(nil),           // 193: lightbits.api.duros.v2.DeleteIdpClientConfRequest
	(*DeleteIdpClientConfResponse)(nil),          // 194: lightbits.api.duros.v2.DeleteIdpClientConfResponse
	(*ListIdpClientConfsRequest)(nil),            // 195: lightbits.api.duros.v2.ListIdpClientConfsRequest
	(*ListIdpClientConfsResponse)(nil),           // 196: lightbits.api.duros.v2.ListIdpClientConfsResponse
	(*AuthMapEntry)(nil),                         // 197: lightbits.api.duros.v2.AuthMapEntry
	(*CreateAuthMapEntryRequest)(nil),            // 198: lightbits.api.duros.v2.CreateAuthMapEntryRequest
	(*UpdateAuthMapEntryRequest)(nil),            // 199: lightbits.api.duros.v2.UpdateAuthMapEntryRequest
	(*DeleteAuthMapEntryRequest)(nil),            // 200: lightbits.api.duros.v2.DeleteAuthMapEntryRequest
	(*GetAuthMapEntryRequest)(nil),               // 201: lightbits.api.duros.v2.GetAuthMapEntryRequest
	(*ListAuthMapEntriesRequest)(nil),            // 202: lightbits.api.duros.v2.ListAuthMapEntriesRequest
	(*DeleteAuthMapEntryResponse)(nil),           // 203: lightbits.api.duros.v2.DeleteAuthMapEntryResponse
	(*ListAuthMapEntriesResponse)(nil),           // 204: lightbits.api.duros.v2.ListAuthMapEntriesResponse
	nil,                                          // 205: lightbits.api.duros.v2.ListFeatureFlagsResponse.FeatureFlagsEntry
	nil,                                          // 206: lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMapEntry
	(*QoSRateLimitPolicy_QoSLimitIOPS)(nil),      // 207: lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPS
	(*QoSRateLimitPolicy_QoSLimitBW)(nil),        // 208: lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitBW
	(*QoSRateLimitPolicy_QoSLimitIOPSPerGB)(nil), // 209: lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPSPerGB
	(*GetClusterRootKeyResponse_KeyObject)(nil),  // 210: lightbits.api.duros.v2.GetClusterRootKeyResponse.KeyObject
	(*Label)(nil),                                // 211: lightbits.api.duros.v2.Label
	(*durationpb.Duration)(nil),                  // 212: google.protobuf.Duration
	(*ProxyInfo)(nil),                            // 213: lightbits.api.duros.v2.ProxyInfo
	(*timestamppb.Timestamp)(nil),                // 214: google.protobuf.Timestamp
	(*NvmeDeviceStatisticsApi)(nil),              // 215: lightbits.api.duros.v2.NvmeDeviceStatisticsApi
	(*NodeStatisticsApi)(nil),                    // 216: lightbits.api.duros.v2.NodeStatisticsApi
	(*ClusterStatisticsApi)(nil),                 // 217: lightbits.api.duros.v2.ClusterStatisticsApi
	(*VolumeStatisticsApi)(nil),                  // 218: lightbits.api.duros.v2.VolumeStatisticsApi
	(*SnapshotStatisticsApi)(nil),                // 219: lightbits.api.duros.v2.SnapshotStatisticsApi
	(*SchedulePolicy)(nil),                       // 220: lightbits.api.duros.v2.SchedulePolicy
	(AuthorizationMode)(0),                       // 221: lightbits.api.duros.v2.AuthorizationMode
	(*EnableClusterInBandAuthRequest)(nil),       // 222: lightbits.api.duros.v2.EnableClusterInBandAuthRequest
	(*DisableClusterInBandAuthRequest)(nil),      // 223: lightbits.api.duros.v2.DisableClusterInBandAuthRequest
	(*CreateTrustedHostRequest)(nil),             // 224: lightbits.api.duros.v2.CreateTrustedHostRequest
	(*DeleteTrustedHostRequest)(nil),             // 225: lightbits.api.duros.v2.DeleteTrustedHostRequest
	(*GetTrustedHostRequest)(nil),                // 226: lightbits.api.duros.v2.GetTrustedHostRequest
	(*ListTrustedHostsRequest)(nil),              // 227: lightbits.api.duros.v2.ListTrustedHostsRequest
	(*UpdateTrustedHostRequest)(nil),             // 228: lightbits.api.duros.v2.UpdateTrustedHostRequest
	(*SetTrustedHostSecretsRequest)(nil),         // 229: lightbits.api.duros.v2.SetTrustedHostSecretsRequest
	(*GetTrustedHostSecretsRequest)(nil),         // 230: lightbits.api.duros.v2.GetTrustedHostSecretsRequest
	(*httpbody.HttpBody)(nil),                    // 231: google.api.HttpBody
	(*EnableClusterInBandAuthResponse)(nil),      // 232: lightbits.api.duros.v2.EnableClusterInBandAuthResponse
	(*DisableClusterInBandAuthResponse)(nil),     // 233: lightbits.api.duros.v2.DisableClusterInBandAuthResponse
	(*TrustedHost)(nil),                          // 234: lightbits.api.duros.v2.TrustedHost
	(*DeleteTrustedHostResponse)(nil),            // 235: lightbits.api.duros.v2.DeleteTrustedHostResponse
	(*ListTrustedHostsResponse)(nil),             // 236: lightbits.api.duros.v2.ListTrustedHostsResponse
	(*SetTrustedHostSecretsResponse)(nil),        // 237: lightbits.api.duros.v2.SetTrustedHostSecretsResponse
	(*GetTrustedHostSecretsResponse)(nil),        // 238: lightbits.api.duros.v2.GetTrustedHostSecretsResponse
}
var file_lightbits_api_duros_v2_durosapiv2_proto_depIdxs = []int32{
	33,  // 0: lightbits.api.duros.v2.ListAdminEndpointsResponse.adminEndpoints:type_name -> lightbits.api.duros.v2.AdminEndpoint
	...
	42,  // 4: lightbits.api.duros.v2.ListCredentialsResponse.credentials:type_name -> lightbits.api.duros.v2.Credential
	4,   // 5: lightbits.api.duros.v2.DefaultPolicy.policyType:type_name -> lightbits.api.duros.v2.PolicyType
	48,  // 6: lightbits.api.duros.v2.CreateProjectRequest.defaultPolicies:type_name -> lightbits.api.duros.v2.DefaultPolicy
	48,  // 7: lightbits.api.duros.v2.Project.defaultPolicies:type_name -> lightbits.api.duros.v2.DefaultPolicy
	50,  // 8: lightbits.api.duros.v2.ListProjectsResponse.projects:type_name -> lightbits.api.duros.v2.Project
	56,  // 9: lightbits.api.duros.v2.CreateVolumeRequest.acl:type_name -> lightbits.api.duros.v2.StringList
	56,  // 10: lightbits.api.duros.v2.CreateVolumeRequest.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	...
	159, // 12: lightbits.api.duros.v2.CreateVolumeRequest.placementRestrictions:type_name -> lightbits.api.duros.v2.LabelMatchExpression
	211, // 13: lightbits.api.duros.v2.CreateVolumeRequest.labels:type_name -> lightbits.api.duros.v2.Label
	212, // 14: lightbits.api.duros.v2.DisableServerRequest.permanentFailureTimeout:type_name -> google.protobuf.Duration
	56,  // 15: lightbits.api.duros.v2.UpdateVolumeRequest.acl:type_name -> lightbits.api.duros.v2.StringList
	56,  // 16: lightbits.api.duros.v2.UpdateVolumeRequest.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	211, // 17: lightbits.api.duros.v2.UpdateVolumeRequest.labels:type_name -> lightbits.api.duros.v2.Label
	213, // 18: lightbits.api.duros.v2.UpgradeServerRequest.ProxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	213, // 19: lightbits.api.duros.v2.UpgradeClusterRequest.ProxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	7,   // 20: lightbits.api.duros.v2.EnableClusterEncryptionRequest.keyStore:type_name -> lightbits.api.duros.v2.EnableClusterEncryptionRequest.KeyStore
	85,  // 21: lightbits.api.duros.v2.ListHostsResponse.connectedHosts:type_name -> lightbits.api.duros.v2.ConnectedHost
	171, // 22: lightbits.api.duros.v2.ListEventsResponse.events:type_name -> lightbits.api.duros.v2.Event
	86,  // 23: lightbits.api.duros.v2.ListNvmeDevicesResponse.NvmeDevices:type_name -> lightbits.api.duros.v2.UserNvmeDevicesResponse
	8,   // 24: lightbits.api.duros.v2.UserNvmeDevicesResponse.state:type_name -> lightbits.api.duros.v2.UserNvmeDevicesResponse.StateEnum
	214, // 25: lightbits.api.duros.v2.UserNvmeDevicesResponse.failureTime:type_name -> google.protobuf.Timestamp
	214, // 26: lightbits.api.duros.v2.UserNvmeDevicesResponse.rebuildCompletionTime:type_name -> google.protobuf.Timestamp
	215, // 27: lightbits.api.duros.v2.UserNvmeDevicesResponse.statistics:type_name -> lightbits.api.duros.v2.NvmeDeviceStatisticsApi
	9,   // 28: lightbits.api.duros.v2.DurosNodeInfo.state:type_name -> lightbits.api.duros.v2.DurosNodeInfo.State
	10,  // 29: lightbits.api.duros.v2.DurosNodeInfo.status:type_name -> lightbits.api.duros.v2.DurosNodeInfo.StatusEnum
	216, // 30: lightbits.api.duros.v2.DurosNodeInfo.statistics:type_name -> lightbits.api.duros.v2.NodeStatisticsApi
	87,  // 31: lightbits.api.duros.v2.ListNodesResponse.nodes:type_name -> lightbits.api.duros.v2.DurosNodeInfo
	109, // 32: lightbits.api.duros.v2.ListVolumesResponse.volumes:type_name -> lightbits.api.duros.v2.Volume
	19,  // 33: lightbits.api.duros.v2.ListServersRequest.RiskOfServiceLoss:type_name -> lightbits.api.duros.v2.Server.RiskOfServiceLossEnum
	112, // 34: lightbits.api.duros.v2.ListServersResponse.servers:type_name -> lightbits.api.duros.v2.Server
	106, // 35: lightbits.api.duros.v2.ClusterUpgradeStatusResponse.cluster:type_name -> lightbits.api.duros.v2.ClusterInfo
	112, // 36: lightbits.api.duros.v2.ListUpgradeStatusResponse.servers:type_name -> lightbits.api.duros.v2.Server
	11,  // 37: lightbits.api.duros.v2.ClusterLastUpgrade.Status:type_name -> lightbits.api.duros.v2.ClusterLastUpgrade.UpgradeStatusEnum
	214, // 38: lightbits.api.duros.v2.ClusterLastUpgrade.StartTime:type_name -> google.protobuf.Timestamp
	214, // 39: lightbits.api.duros.v2.ClusterLastUpgrade.EndTime:type_name -> google.protobuf.Timestamp
	217, // 40: lightbits.api.duros.v2.ClusterInfo.statistics:type_name -> lightbits.api.duros.v2.ClusterStatisticsApi
	108, // 41: lightbits.api.duros.v2.ClusterInfo.health:type_name -> lightbits.api.duros.v2.ClusterHealth
	105, // 42: lightbits.api.duros.v2.ClusterInfo.lastUpgrade:type_name -> lightbits.api.duros.v2.ClusterLastUpgrade
	12,  // 43: lightbits.api.duros.v2.ClusterInfo.inBandAuthMode:type_name -> lightbits.api.duros.v2.ClusterInfo.AuthenticationMode
	105, // 44: lightbits.api.duros.v2.ClusterInfoV2.lastUpgrade:type_name -> lightbits.api.duros.v2.ClusterLastUpgrade
	176, // 45: lightbits.api.duros.v2.ClusterInfoV2.encryptionStatus:type_name -> lightbits.api.duros.v2.ClusterEncryptionStatus
	13,  // 46: lightbits.api.duros.v2.ClusterHealth.state:type_name -> lightbits.api.duros.v2.ClusterHealth.State
	14,  // 47: lightbits.api.duros.v2.Volume.state:type_name -> lightbits.api.duros.v2.Volume.StateEnum
	2,   // 48: lightbits.api.duros.v2.Volume.protectionState:type_name -> lightbits.api.duros.v2.ProtectionStateEnum
	56,  // 49: lightbits.api.duros.v2.Volume.acl:type_name -> lightbits.api.duros.v2.StringList
	218, // 50: lightbits.api.duros.v2.Volume.statistics:type_name -> lightbits.api.duros.v2.VolumeStatisticsApi
	56,  // 51: lightbits.api.duros.v2.Volume.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	159, // 52: lightbits.api.duros.v2.Volume.placementRestrictions:type_name -> lightbits.api.duros.v2.LabelMatchExpression
	214, // 53: lightbits.api.duros.v2.Volume.creationTime:type_name -> google.protobuf.Timestamp
	211, // 54: lightbits.api.duros.v2.Volume.labels:type_name -> lightbits.api.duros.v2.Label
	16,  // 55: lightbits.api.duros.v2.ServerEvictionStatus.status:type_name -> lightbits.api.duros.v2.ServerEvictionStatus.StatusEnum
	214, // 56: lightbits.api.duros.v2.ServerEvictionStatus.startTime:type_name -> google.protobuf.Timestamp
	214, // 57: lightbits.api.duros.v2.ServerEvictionStatus.endTime:type_name -> google.protobuf.Timestamp
	17,  // 58: lightbits.api.duros.v2.ServerLastUpgrade.Status:type_name -> lightbits.api.duros.v2.ServerLastUpgrade.UpgradeStatusEnum
	214, // 59: lightbits.api.duros.v2.ServerLastUpgrade.StartTime:type_name -> google.protobuf.Timestamp
	214, // 60: lightbits.api.duros.v2.ServerLastUpgrade.EndTime:type_name -> google.protobuf.Timestamp
	19,  // 61: lightbits.api.duros.v2.Server.RiskOfServiceLossState:type_name -> lightbits.api.duros.v2.Server.RiskOfServiceLossEnum
	20,  // 62: lightbits.api.duros.v2.Server.state:type_name -> lightbits.api.duros.v2.Server.ServerStateEnum
	18,  // 63: lightbits.api.duros.v2.Server.UpgradeStatus:type_name -> lightbits.api.duros.v2.Server.UpgradeStatusEnum
	111, // 64: lightbits.api.duros.v2.Server.LastUpgrade:type_name -> lightbits.api.duros.v2.ServerLastUpgrade
	110, // 65: lightbits.api.duros.v2.Server.LastEviction:type_name -> lightbits.api.duros.v2.ServerEvictionStatus
	13,  // 66: lightbits.api.duros.v2.Server.health:type_name -> lightbits.api.duros.v2.ClusterHealth.State
	212, // 67: lightbits.api.duros.v2.Server.ServerPermanenetFailureTimeout:type_name -> google.protobuf.Duration
	115, // 68: lightbits.api.duros.v2.GetRoleResponse.role:type_name -> lightbits.api.duros.v2.Role
	115, // 69: lightbits.api.duros.v2.ListRolesResponse.roles:type_name -> lightbits.api.duros.v2.Role
	21,  // 70: lightbits.api.duros.v2.Snapshot.state:type_name -> lightbits.api.duros.v2.Snapshot.StateEnum
	214, // 71: lightbits.api.duros.v2.Snapshot.creationTime:type_name -> google.protobuf.Timestamp
	212, // 72: lightbits.api.duros.v2.Snapshot.retentionTime:type_name -> google.protobuf.Duration
	56,  // 73: lightbits.api.duros.v2.Snapshot.acl:type_name -> lightbits.api.duros.v2.StringList
	56,  // 74: lightbits.api.duros.v2.Snapshot.IPAcl:type_name -> lightbits.api.duros.v2.StringList
	219, // 75: lightbits.api.duros.v2.Snapshot.statistics:type_name -> lightbits.api.duros.v2.SnapshotStatisticsApi
	211, // 76: lightbits.api.duros.v2.Snapshot.labels:type_name -> lightbits.api.duros.v2.Label
	212, // 77: lightbits.api.duros.v2.CreateSnapshotRequest.retentionTime:type_name -> google.protobuf.Duration
	118, // 78: lightbits.api.duros.v2.ListSnapshotsResponse.snapshots:type_name -> lightbits.api.duros.v2.Snapshot
	205, // 79: lightbits.api.duros.v2.ListFeatureFlagsResponse.featureFlags:type_name -> lightbits.api.duros.v2.ListFeatureFlagsResponse.FeatureFlagsEntry
	220, // 80: lightbits.api.duros.v2.CreateResourcePolicyRequest.schedulePolicy:type_name -> lightbits.api.duros.v2.SchedulePolicy
	172, // 81: lightbits.api.duros.v2.CreatePolicyRequest.qoSRateLimitPolicy:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy
	172, // 82: lightbits.api.duros.v2.UpdatePolicyRequest.qoSRateLimitPolicy:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy
	220, // 83: lightbits.api.duros.v2.ResourcePolicy.schedulePolicy:type_name -> lightbits.api.duros.v2.SchedulePolicy
	22,  // 84: lightbits.api.duros.v2.ResourcePolicy.state:type_name -> lightbits.api.duros.v2.ResourcePolicy.State
	23,  // 85: lightbits.api.duros.v2.Policy.state:type_name -> lightbits.api.duros.v2.Policy.State
	172, // 86: lightbits.api.duros.v2.Policy.QoSRateLimitPolicy:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy
	220, // 87: lightbits.api.duros.v2.UpdateResourcePolicyRequest.schedulePolicy:type_name -> lightbits.api.duros.v2.SchedulePolicy
	137, // 88: lightbits.api.duros.v2.ListPoliciesResponse.policies:type_name -> lightbits.api.duros.v2.Policy
	136, // 89: lightbits.api.duros.v2.ListResourcePoliciesResponse.resourcePolicies:type_name -> lightbits.api.duros.v2.ResourcePolicy
	173, // 90: lightbits.api.duros.v2.ListResourcePoliciesResponse.defaultResourcePolicies:type_name -> lightbits.api.duros.v2.DefaultGlobalResourcePolicy
	151, // 91: lightbits.api.duros.v2.UpdateClusterConfigParamRequest.configParam:type_name -> lightbits.api.duros.v2.ClusterConfigParam
	151, // 92: lightbits.api.duros.v2.ListClusterConfigParamsResponse.values:type_name -> lightbits.api.duros.v2.ClusterConfigParam
	24,  // 93: lightbits.api.duros.v2.LabelValueKeyPair.key:type_name -> lightbits.api.duros.v2.LabelValueKeyPair.Key
	25,  // 94: lightbits.api.duros.v2.LabelMatchExpression.operator:type_name -> lightbits.api.duros.v2.LabelMatchExpression.Operator
	158, // 95: lightbits.api.duros.v2.LabelMatchExpression.labelValueKeyPairs:type_name -> lightbits.api.duros.v2.LabelValueKeyPair
	160, // 96: lightbits.api.duros.v2.VolumeComponentInfoList.VolumeComponentInfoList:type_name -> lightbits.api.duros.v2.ComponentVolumeInfo
	206, // 97: lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMap:type_name -> lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMapEntry
	168, // 98: lightbits.api.duros.v2.ListChangedBlocksResponse.lbaRanges:type_name -> lightbits.api.duros.v2.LBARange
	214, // 99: lightbits.api.duros.v2.Event.Time:type_name -> google.protobuf.Timestamp
	26,  // 100: lightbits.api.duros.v2.Event.Type:type_name -> lightbits.api.duros.v2.Event.EventType
	28,  // 101: lightbits.api.duros.v2.Event.Severity:type_name -> lightbits.api.duros.v2.Event.EventSeverity
	27,  // 102: lightbits.api.duros.v2.Event.ReportingService:type_name -> lightbits.api.duros.v2.Event.EventReportingService
	162, // 103: lightbits.api.duros.v2.Event.ComponentVolumesInfo:type_name -> lightbits.api.duros.v2.ComponentVolumesInfo
	165, // 104: lightbits.api.duros.v2.Event.ComponentNVMeSSDInfo:type_name -> lightbits.api.duros.v2.ComponentNVMeSSDInfo
	163, // 105: lightbits.api.duros.v2.Event.ComponentNodeInfo:type_name -> lightbits.api.duros.v2.ComponentNodeInfo
	166, // 106: lightbits.api.duros.v2.Event.ComponentServerInfo:type_name -> lightbits.api.duros.v2.ComponentServerInfo
	164, // 107: lightbits.api.duros.v2.Event.ComponentClusterInfo:type_name -> lightbits.api.duros.v2.ComponentClusterInfo
	167, // 108: lightbits.api.duros.v2.Event.ComponentDataIntegrityInfo:type_name -> lightbits.api.duros.v2.ComponentDataIntegrityInfo
	3,   // 109: lightbits.api.duros.v2.QoSRateLimitPolicy.policyVisibility:type_name -> lightbits.api.duros.v2.PolicyVisibility
	207, // 110: lightbits.api.duros.v2.QoSRateLimitPolicy.limitIOPS:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPS
	208, // 111: lightbits.api.duros.v2.QoSRateLimitPolicy.limitBw:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitBW
	209, // 112: lightbits.api.duros.v2.QoSRateLimitPolicy.limitIOPSPerGB:type_name -> lightbits.api.duros.v2.QoSRateLimitPolicy.QoSLimitIOPSPerGB
	4,   // 113: lightbits.api.duros.v2.DefaultGlobalResourcePolicy.policyType:type_name -> lightbits.api.duros.v2.PolicyType
	48,  // 114: lightbits.api.duros.v2.UpdateProjectRequest.defaultPolicies:type_name -> lightbits.api.duros.v2.DefaultPolicy
	29,  // 115: lightbits.api.duros.v2.ClusterEncryptionStatus.encryptionState:type_name -> lightbits.api.duros.v2.ClusterEncryptionStatus.State
	214, // 116: lightbits.api.duros.v2.ClusterEncryptionStatus.kekUpdateDate:type_name -> google.protobuf.Timestamp
	210, // 117: lightbits.api.duros.v2.GetClusterRootKeyResponse.keys:type_name -> lightbits.api.duros.v2.GetClusterRootKeyResponse.KeyObject
	30,  // 118: lightbits.api.duros.v2.IDPConfiguration.state:type_name -> lightbits.api.duros.v2.IDPConfiguration.IDPConfigurationState
	5,   // 119: lightbits.api.duros.v2.IDPConfiguration.Type:type_name -> lightbits.api.duros.v2.IDPType
	213, // 120: lightbits.api.duros.v2.IDPConfiguration.ProxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	5,   // 121: lightbits.api.duros.v2.CreateIDPConfigurationRequest.Type:type_name -> lightbits.api.duros.v2.IDPType
	213, // 122: lightbits.api.duros.v2.CreateIDPConfigurationRequest.ProxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	5,   // 123: lightbits.api.duros.v2.UpdateIDPConfigurationRequest.Type:type_name -> lightbits.api.duros.v2.IDPType
	213, // 124: lightbits.api.duros.v2.UpdateIDPConfigurationRequest.ProxyInfo:type_name -> lightbits.api.duros.v2.ProxyInfo
	181, // 125: lightbits.api.duros.v2.ListIDPConfigurationsResponse.IDPConfigurations:type_name -> lightbits.api.duros.v2.IDPConfiguration
	221, // 126: lightbits.api.duros.v2.IdpClientConf.authzMode:type_name -> lightbits.api.duros.v2.AuthorizationMode
	221, // 127: lightbits.api.duros.v2.CreateIdpClientConfRequest.authzMode:type_name -> lightbits.api.duros.v2.AuthorizationMode
	189, // 128: lightbits.api.duros.v2.ListIdpClientConfsResponse.IdpClientConfs:type_name -> lightbits.api.duros.v2.IdpClientConf
	31,  // 129: lightbits.api.duros.v2.AuthMapEntry.state:type_name -> lightbits.api.duros.v2.AuthMapEntry.StateEnum
	221, // 130: lightbits.api.duros.v2.AuthMapEntry.authzMode:type_name -> lightbits.api.duros.v2.AuthorizationMode
	221, // 131: lightbits.api.duros.v2.CreateAuthMapEntryRequest.authzMode:type_name -> lightbits.api.duros.v2.AuthorizationMode
	221, // 132: lightbits.api.duros.v2.UpdateAuthMapEntryRequest.authzMode:type_name -> lightbits.api.duros.v2.AuthorizationMode
	197, // 133: lightbits.api.duros.v2.ListAuthMapEntriesResponse.AuthMapEntries:type_name -> lightbits.api.duros.v2.AuthMapEntry
	125, // 134: lightbits.api.duros.v2.ListFeatureFlagsResponse.FeatureFlagsEntry.value:type_name -> lightbits.api.duros.v2.FeatureFlagStatus
	161, // 135: lightbits.api.duros.v2.ComponentVolumesInfo.ProjectVolumesMapEntry.value:type_name -> lightbits.api.duros.v2.VolumeComponentInfoList
	57,  // 136: lightbits.api.duros.v2.DurosAPI.GetVersion:input_type -> lightbits.api.duros.v2.GetVersionRequest
	58,  // 137: lightbits.api.duros.v2.DurosAPI.CreateVolume:input_type -> lightbits.api.duros.v2.CreateVolumeRequest
	59,  // 138: lightbits.api.duros.v2.DurosAPI.DeleteVolume:input_type -> lightbits.api.duros.v2.DeleteVolumeRequest
	81,  // 139: lightbits.api.duros.v2.DurosAPI.ListVolumes:input_type -> lightbits.api.duros.v2.ListVolumeRequest
	77,  // 140: lightbits.api.duros.v2.DurosAPI.ListEvents:input_type -> lightbits.api.duros.v2.ListEventsRequest
	73,  // 141: lightbits.api.duros.v2.DurosAPI.GetHost:input_type -> lightbits.api.duros.v2.GetHostRequest
	74,  // 142: lightbits.api.duros.v2.DurosAPI.ListHosts:input_type -> lightbits.api.duros.v2.ListHostsRequest
	79,  // 143: lightbits.api.duros.v2.DurosAPI.GetVolume:input_type -> lightbits.api.duros.v2.GetVolumeRequest
	76,  // 144: lightbits.api.duros.v2.DurosAPI.ListNodes:input_type -> lightbits.api.duros.v2.ListNodeRequest
	80,  // 145: lightbits.api.duros.v2.DurosAPI.GetNode:input_type -> lightbits.api.duros.v2.GetNodeRequest
	82,  // 146: lightbits.api.duros.v2.DurosAPI.ListNvmeDevices:input_type -> lightbits.api.duros.v2.ListNvmeDevicesRequest
	83,  // 147: lightbits.api.duros.v2.DurosAPI.GetNvmeDevice:input_type -> lightbits.api.duros.v2.GetNvmeDeviceRequest
	32,  // 148: lightbits.api.duros.v2.DurosAPI.FetchLogs:input_type -> lightbits.api.duros.v2.LogRequest
	70,  // 149: lightbits.api.duros.v2.DurosAPI.GetCluster:input_type -> lightbits.api.duros.v2.GetClusterRequest
	70,  // 150: lightbits.api.duros.v2.DurosAPI.GetClusterInfo:input_type -> lightbits.api.duros.v2.GetClusterRequest
	71,  // 151: lightbits.api.duros.v2.DurosAPI.UpdateNvmeDevice:input_type -> lightbits.api.duros.v2.UpdateNvmeDeviceRequest
	72,  // 152: lightbits.api.duros.v2.DurosAPI.AddNvmeDevice:input_type -> lightbits.api.duros.v2.AddNvmeDeviceRequest
	66,  // 153: lightbits.api.duros.v2.DurosAPI.UpdateVolume:input_type -> lightbits.api.duros.v2.UpdateVolumeRequest
	100, // 154: lightbits.api.duros.v2.DurosAPI.GetServer:input_type -> lightbits.api.duros.v2.GetServerRequest
	99,  // 155: lightbits.api.duros.v2.DurosAPI.ListServers:input_type -> lightbits.api.duros.v2.ListServersRequest
	67,  // 156: lightbits.api.duros.v2.DurosAPI.UpgradeServer:input_type -> lightbits.api.duros.v2.UpgradeServerRequest
	68,  // 157: lightbits.api.duros.v2.DurosAPI.UpgradeCluster:input_type -> lightbits.api.duros.v2.UpgradeClusterRequest
	69,  // 158: lightbits.api.duros.v2.DurosAPI.EnableClusterEncryption:input_type -> lightbits.api.duros.v2.EnableClusterEncryptionRequest
	65,  // 159: lightbits.api.duros.v2.DurosAPI.CreateServer:input_type -> lightbits.api.duros.v2.CreateServerRequest
	64,  // 160: lightbits.api.duros.v2.DurosAPI.ReplaceNode:input_type -> lightbits.api.duros.v2.ReplaceNodeRequest
	63,  // 161: lightbits.api.duros.v2.DurosAPI.DeleteServer:input_type -> lightbits.api.duros.v2.DeleteServerRequest
	61,  // 162: lightbits.api.duros.v2.DurosAPI.EnableServer:input_type -> lightbits.api.duros.v2.EnableServerRequest
	62,  // 163: lightbits.api.duros.v2.DurosAPI.DisableServer:input_type -> lightbits.api.duros.v2.DisableServerRequest
	49,  // 164: lightbits.api.duros.v2.DurosAPI.CreateProject:input_type -> lightbits.api.duros.v2.CreateProjectRequest
	174, // 165: lightbits.api.duros.v2.DurosAPI.UpdateProject:input_type -> lightbits.api.duros.v2.UpdateProjectRequest
	51,  // 166: lightbits.api.duros.v2.DurosAPI.DeleteProject:input_type -> lightbits.api.duros.v2.DeleteProjectRequest
	53,  // 167: lightbits.api.duros.v2.DurosAPI.ListProjects:input_type -> lightbits.api.duros.v2.ListProjectsRequest
	55,  // 168: lightbits.api.duros.v2.DurosAPI.GetProject:input_type -> lightbits.api.duros.v2.GetProjectRequest
	41,  // 169: lightbits.api.duros.v2.DurosAPI.CreateCredential:input_type -> lightbits.api.duros.v2.CreateCredentialRequest
	43,  // 170: lightbits.api.duros.v2.DurosAPI.DeleteCredential:input_type -> lightbits.api.duros.v2.DeleteCredentialRequest
	45,  // 171: lightbits.api.duros.v2.DurosAPI.ListCredentials:input_type -> lightbits.api.duros.v2.ListCredentialsRequest
	47,  // 172: lightbits.api.duros.v2.DurosAPI.GetCredential:input_type -> lightbits.api.duros.v2.GetCredentialRequest
	113, // 173: lightbits.api.duros.v2.DurosAPI.GetRole:input_type -> lightbits.api.duros.v2.GetRoleRequest
	116, // 174: lightbits.api.duros.v2.DurosAPI.ListRoles:input_type -> lightbits.api.duros.v2.ListRolesRequest
	37,  // 175: lightbits.api.duros.v2.DurosAPI.CreateAdminEndpoint:input_type -> lightbits.api.duros.v2.CreateAdminEndpointRequest
	39,  // 176: lightbits.api.duros.v2.DurosAPI.DeleteAdminEndpoint:input_type -> lightbits.api.duros.v2.DeleteAdminEndpointRequest
	36,  // 177: lightbits.api.duros.v2.DurosAPI.ListAdminEndpoints:input_type -> lightbits.api.duros.v2.ListAdminEndpointsRequest
	38,  // 178: lightbits.api.duros.v2.DurosAPI.UpdateAdminEndpoint:input_type -> lightbits.api.duros.v2.UpdateAdminEndpointRequest
	34,  // 179: lightbits.api.duros.v2.DurosAPI.GetAdminEndpoint:input_type -> lightbits.api.duros.v2.GetAdminEndpointRequest
	132, // 180: lightbits.api.duros.v2.DurosAPI.CreateResourcePolicy:input_type -> lightbits.api.duros.v2.CreateResourcePolicyRequest
	133, // 181: lightbits.api.duros.v2.DurosAPI.CreatePolicy:input_type -> lightbits.api.duros.v2.CreatePolicyRequest
	134, // 182: lightbits.api.duros.v2.DurosAPI.UpdatePolicy:input_type -> lightbits.api.duros.v2.UpdatePolicyRequest
	138, // 183: lightbits.api.duros.v2.DurosAPI.UpdateResourcePolicy:input_type -> lightbits.api.duros.v2.UpdateResourcePolicyRequest
	144, // 184: lightbits.api.duros.v2.DurosAPI.GetPolicy:input_type -> lightbits.api.duros.v2.GetPolicyRequest
	140, // 185: lightbits.api.duros.v2.DurosAPI.ListPolicies:input_type -> lightbits.api.duros.v2.ListPoliciesRequest
	142, // 186: lightbits.api.duros.v2.DurosAPI.ListResourcePolicies:input_type -> lightbits.api.duros.v2.ListResourcePoliciesRequest
	145, // 187: lightbits.api.duros.v2.DurosAPI.GetResourcePolicy:input_type -> lightbits.api.duros.v2.GetResourcePolicyRequest
	146, // 188: lightbits.api.duros.v2.DurosAPI.DeleteResourcePolicy:input_type -> lightbits.api.duros.v2.DeleteResourcePolicyRequest
	148, // 189: lightbits.api.duros.v2.DurosAPI.DeletePolicy:input_type -> lightbits.api.duros.v2.DeletePolicyRequest
	120, // 190: lightbits.api.duros.v2.DurosAPI.CreateSnapshot:input_type -> lightbits.api.duros.v2.CreateSnapshotRequest
	122, // 191: lightbits.api.duros.v2.DurosAPI.GetSnapshot:input_type -> lightbits.api.duros.v2.GetSnapshotRequest
	121, // 192: lightbits.api.duros.v2.DurosAPI.ListSnapshots:input_type -> lightbits.api.duros.v2.ListSnapshotsRequest
	119, // 193: lightbits.api.duros.v2.DurosAPI.DeleteSnapshot:input_type -> lightbits.api.duros.v2.DeleteSnapshotRequest
	126, // 194: lightbits.api.duros.v2.DurosAPI.GetFeatureFlag:input_type -> lightbits.api.duros.v2.GetFeatureFlagRequest
	127, // 195: lightbits.api.duros.v2.DurosAPI.EnableFeatureFlag:input_type -> lightbits.api.duros.v2.EnableFeatureFlagRequest
	128, // 196: lightbits.api.duros.v2.DurosAPI.DisableFeatureFlag:input_type -> lightbits.api.duros.v2.DisableFeatureFlagRequest
	130, // 197: lightbits.api.duros.v2.DurosAPI.ListFeatureFlags:input_type -> lightbits.api.duros.v2.ListFeatureFlagsRequest
	150, // 198: lightbits.api.duros.v2.DurosAPI.GetClusterConfigParam:input_type -> lightbits.api.duros.v2.GetClusterConfigParamRequest
	152, // 199: lightbits.api.duros.v2.DurosAPI.UpdateClusterConfigParam:input_type -> lightbits.api.duros.v2.UpdateClusterConfigParamRequest
	156, // 200: lightbits.api.duros.v2.DurosAPI.ListClusterConfigParams:input_type -> lightbits.api.duros.v2.ListClusterConfigParamsRequest
	153, // 201: lightbits.api.duros.v2.DurosAPI.RollbackVolume:input_type -> lightbits.api.duros.v2.RollbackVolumeRequest
	169, // 202: lightbits.api.duros.v2.DurosAPI.ListChangedBlocks:input_type -> lightbits.api.duros.v2.ListChangedBlocksRequest
	177, // 203: lightbits.api.duros.v2.DurosAPI.RotateClusterRootKey:input_type -> lightbits.api.duros.v2.RotateClusterRootKeyRequest
	179, // 204: lightbits.api.duros.v2.DurosAPI.GetClusterRootKey:input_type -> lightbits.api.duros.v2.GetClusterRootKeyRequest
	182, // 205: lightbits.api.duros.v2.DurosAPI.CreateIdpConfiguration:input_type -> lightbits.api.duros.v2.CreateIDPConfigurationRequest
	187, // 206: lightbits.api.duros.v2.DurosAPI.DeleteIdpConfiguration:input_type -> lightbits.api.duros.v2.DeleteIDPConfigurationRequest
	183, // 207: lightbits.api.duros.v2.DurosAPI.UpdateIdpConfiguration:input_type -> lightbits.api.duros.v2.UpdateIDPConfigurationRequest
	184, // 208: lightbits.api.duros.v2.DurosAPI.ListIdpConfigurations:input_type -> lightbits.api.duros.v2.ListIDPConfigurationsRequest
	186, // 209: lightbits.api.duros.v2.DurosAPI.GetIdpConfiguration:input_type -> lightbits.api.duros.v2.GetIDPConfigurationRequest
	190, // 210: lightbits.api.duros.v2.DurosAPI.CreateIdpClientConf:input_type -> lightbits.api.duros.v2.CreateIdpClientConfRequest
	193, // 211: lightbits.api.duros.v2.DurosAPI.DeleteIdpClientConf:input_type -> lightbits.api.duros.v2.DeleteIdpClientConfRequest
	191, // 212: lightbits.api.duros.v2.DurosAPI.UpdateIdpClientConf:input_type -> lightbits.api.duros.v2.UpdateIdpClientConfRequest
	195, // 213: lightbits.api.duros.v2.DurosAPI.ListIdpClientConfs:input_type -> lightbits.api.duros.v2.ListIdpClientConfsRequest
	192, // 214: lightbits.api.duros.v2.DurosAPI.GetIdpClientConf:input_type -> lightbits.api.duros.v2.GetIdpClientConfRequest
	198, // 215: lightbits.api.duros.v2.DurosAPI.CreateAuthMapEntry:input_type -> lightbits.api.duros.v2.CreateAuthMapEntryRequest
	199, // 216: lightbits.api.duros.v2.DurosAPI.UpdateAuthMapEntry:input_type -> lightbits.api.duros.v2.UpdateAuthMapEntryRequest
	200, // 217: lightbits.api.duros.v2.DurosAPI.DeleteAuthMapEntry:input_type -> lightbits.api.duros.v2.DeleteAuthMapEntryRequest
	201, // 218: lightbits.api.duros.v2.DurosAPI.GetAuthMapEntry:input_type -> lightbits.api.duros.v2.GetAuthMapEntryRequest
	202, // 219: lightbits.api.duros.v2.DurosAPI.ListAuthMapEntries:input_type -> lightbits.api.duros.v2.ListAuthMapEntriesRequest
	222, // 220: lightbits.api.duros.v2.DurosAPI.EnableClusterInBandAuth:input_type -> lightbits.api.duros.v2.EnableClusterInBandAuthRequest
	223, // 221: lightbits.api.duros.v2.DurosAPI.DisableClusterInBandAuth:input_type -> lightbits.api.duros.v2.DisableClusterInBandAuthRequest
	224, // 222: lightbits.api.duros.v2.DurosAPI.CreateTrustedHost:input_type -> lightbits.api.duros.v2.CreateTrustedHostRequest
	225, // 223: lightbits.api.duros.v2.DurosAPI.DeleteTrustedHost:input_type -> lightbits.api.duros.v2.DeleteTrustedHostRequest
	226, // 224: lightbits.api.duros.v2.DurosAPI.GetTrustedHost:input_type -> lightbits.api.duros.v2.GetTrustedHostRequest
	227, // 225: lightbits.api.duros.v2.DurosAPI.ListTrustedHosts:input_type -> lightbits.api.duros.v2.ListTrustedHostsRequest
	228, // 226: lightbits.api.duros.v2.DurosAPI.UpdateTrustedHost:input_type -> lightbits.api.duros.v2.UpdateTrustedHostRequest
	229, // 227: lightbits.api.duros.v2.DurosAPI.SetTrustedHostSecret:input_type -> lightbits.api.duros.v2.SetTrustedHostSecretsRequest
	230, // 228: lightbits.api.duros.v2.DurosAPI.GetTrustedHostSecret:input_type -> lightbits.api.duros.v2.GetTrustedHostSecretsRequest
	104, // 229: lightbits.api.duros.v2.DurosAPI.GetVersion:output_type -> lightbits.api.duros.v2.Version
	109, // 230: lightbits.api.duros.v2.DurosAPI.CreateVolume:output_type -> lightbits.api.duros.v2.Volume
	60,  // 231: lightbits.api.duros.v2.DurosAPI.DeleteVolume:output_type -> lightbits.api.duros.v2.DeleteVolumeResponse
	89,  // 232: lightbits.api.duros.v2.DurosAPI.ListVolumes:output_type -> lightbits.api.duros.v2.ListVolumesResponse
	78,  // 233: lightbits.api.duros.v2.DurosAPI.ListEvents:output_type -> lightbits.api.duros.v2.ListEventsResponse
	85,  // 234: lightbits.api.duros.v2.DurosAPI.GetHost:output_type -> lightbits.api.duros.v2.ConnectedHost
	75,  // 235: lightbits.api.duros.v2.DurosAPI.ListHosts:output_type -> lightbits.api.duros.v2.ListHostsResponse
	109, // 236: lightbits.api.duros.v2.DurosAPI.GetVolume:output_type -> lightbits.api.duros.v2.Volume
	88,  // 237: lightbits.api.duros.v2.DurosAPI.ListNodes:output_type -> lightbits.api.duros.v2.ListNodesResponse
	87,  // 238: lightbits.api.duros.v2.DurosAPI.GetNode:output_type -> lightbits.api.duros.v2.DurosNodeInfo
	84,  // 239: lightbits.api.duros.v2.DurosAPI.ListNvmeDevices:output_type -> lightbits.api.duros.v2.ListNvmeDevicesResponse
	86,  // 240: lightbits.api.duros.v2.DurosAPI.GetNvmeDevice:output_type -> lightbits.api.duros.v2.UserNvmeDevicesResponse
	231, // 241: lightbits.api.duros.v2.DurosAPI.FetchLogs:output_type -> google.api.HttpBody
	106, // 242: lightbits.api.duros.v2.DurosAPI.GetCluster:output_type -> lightbits.api.duros.v2.ClusterInfo
	107, // 243: lightbits.api.duros.v2.DurosAPI.GetClusterInfo:output_type -> lightbits.api.duros.v2.ClusterInfoV2
	90,  // 244: lightbits.api.duros.v2.DurosAPI.UpdateNvmeDevice:output_type -> lightbits.api.duros.v2.UpdateNvmeDeviceResponse
	91,  // 245: lightbits.api.duros.v2.DurosAPI.AddNvmeDevice:output_type -> lightbits.api.duros.v2.AddNvmeDeviceResponse
	92,  // 246: lightbits.api.duros.v2.DurosAPI.UpdateVolume:output_type -> lightbits.api.duros.v2.UpdateVolumeResponse
	112, // 247: lightbits.api.duros.v2.DurosAPI.GetServer:output_type -> lightbits.api.duros.v2.Server
	101, // 248: lightbits.api.duros.v2.DurosAPI.ListServers:output_type -> lightbits.api.duros.v2.ListServersResponse
	93,  // 249: lightbits.api.duros.v2.DurosAPI.UpgradeServer:output_type -> lightbits.api.duros.v2.UpgradeServerResponse
	94,  // 250: lightbits.api.duros.v2.DurosAPI.UpgradeCluster:output_type -> lightbits.api.duros.v2.UpgradeClusterResponse
	95,  // 251: lightbits.api.duros.v2.DurosAPI.EnableClusterEncryption:output_type -> lightbits.api.duros.v2.EnableClusterEncryptionResponse
	112, // 252: lightbits.api.duros.v2.DurosAPI.CreateServer:output_type -> lightbits.api.duros.v2.Server
	96,  // 253: lightbits.api.duros.v2.DurosAPI.ReplaceNode:output_type -> lightbits.api.duros.v2.ReplaceNodeResponse
	97,  // 254: lightbits.api.duros.v2.DurosAPI.DeleteServer:output_type -> lightbits.api.duros.v2.DeleteServerResponse
	112, // 255: lightbits.api.duros.v2.DurosAPI.EnableServer:output_type -> lightbits.api.duros.v2.Server
	98,  // 256: lightbits.api.duros.v2.DurosAPI.DisableServer:output_type -> lightbits.api.duros.v2.DisableServerResponse
	50,  // 257: lightbits.api.duros.v2.DurosAPI.CreateProject:output_type -> lightbits.api.duros.v2.Project
	175, // 258: lightbits.api.duros.v2.DurosAPI.UpdateProject:output_type -> lightbits.api.duros.v2.UpdateProjectResponse
	52,  // 259: lightbits.api.duros.v2.DurosAPI.DeleteProject:output_type -> lightbits.api.duros.v2.DeleteProjectResponse
	54,  // 260: lightbits.api.duros.v2.DurosAPI.ListProjects:output_type -> lightbits.api.duros.v2.ListProjectsResponse
	50,  // 261: lightbits.api.duros.v2.DurosAPI.GetProject:output_type -> lightbits.api.duros.v2.Project
	42,  // 262: lightbits.api.duros.v2.DurosAPI.CreateCredential:output_type -> lightbits.api.duros.v2.Credential
	44,  // 263: lightbits.api.duros.v2.DurosAPI.DeleteCredential:output_type -> lightbits.api.duros.v2.DeleteCredentialResponse
	46,  // 264: lightbits.api.duros.v2.DurosAPI.ListCredentials:output_type -> lightbits.api.duros.v2.ListCredentialsResponse
	42,  // 265: lightbits.api.duros.v2.DurosAPI.GetCredential:output_type -> lightbits.api.duros.v2.Credential
	114, // 266: lightbits.api.duros.v2.DurosAPI.GetRole:output_type -> lightbits.api.duros.v2.GetRoleResponse
	117, // 267: lightbits.api.duros.v2.DurosAPI.ListRoles:output_type -> lightbits.api.duros.v2.ListRolesResponse
	33,  // 268: lightbits.api.duros.v2.DurosAPI.CreateAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	...
	35,  // 270: lightbits.api.duros.v2.DurosAPI.ListAdminEndpoints:output_type -> lightbits.api.duros.v2.ListAdminEndpointsResponse
	33,  // 271: lightbits.api.duros.v2.DurosAPI.UpdateAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	33,  // 272: lightbits.api.duros.v2.DurosAPI.GetAdminEndpoint:output_type -> lightbits.api.duros.v2.AdminEndpoint
	136, // 273: lightbits.api.duros.v2.DurosAPI.CreateResourcePolicy:output_type -> lightbits.api.duros.v2.ResourcePolicy
	137, // 274: lightbits.api.duros.v2.DurosAPI.CreatePolicy:output_type -> lightbits.api.duros.v2.Policy
	135, // 275: lightbits.api.duros.v2.DurosAPI.UpdatePolicy:output_type -> lightbits.api.duros.v2.UpdatePolicyResponse
	139, // 276: lightbits.api.duros.v2.DurosAPI.UpdateResourcePolicy:output_type -> lightbits.api.duros.v2.UpdateResourcePolicyResponse
	137, // 277: lightbits.api.duros.v2.DurosAPI.GetPolicy:output_type -> lightbits.api.duros.v2.Policy
	141, // 278: lightbits.api.duros.v2.DurosAPI.ListPolicies:output_type -> lightbits.api.duros.v2.ListPoliciesResponse
	143, // 279: lightbits.api.duros.v2.DurosAPI.ListResourcePolicies:output_type -> lightbits.api.duros.v2.ListResourcePoliciesResponse
	136, // 280: lightbits.api.duros.v2.DurosAPI.GetResourcePolicy:output_type -> lightbits.api.duros.v2.ResourcePolicy
	147, // 281: lightbits.api.duros.v2.DurosAPI.DeleteResourcePolicy:output_type -> lightbits.api.duros.v2.DeleteResourcePolicyResponse
	149, // 282: lightbits.api.duros.v2.DurosAPI.DeletePolicy:output_type -> lightbits.api.duros.v2.DeletePolicyResponse
	118, // 283: lightbits.api.duros.v2.DurosAPI.CreateSnapshot:output_type -> lightbits.api.duros.v2.Snapshot
	118, // 284: lightbits.api.duros.v2.DurosAPI.GetSnapshot:output_type -> lightbits.api.duros.v2.Snapshot
	123, // 285: lightbits.api.duros.v2.DurosAPI.ListSnapshots:output_type -> lightbits.api.duros.v2.ListSnapshotsResponse
	124, // 286: lightbits.api.duros.v2.DurosAPI.DeleteSnapshot:output_type -> lightbits.api.duros.v2.DeleteSnapshotResponse
	125, // 287: lightbits.api.duros.v2.DurosAPI.GetFeatureFlag:output_type -> lightbits.api.duros.v2.FeatureFlagStatus
	129, // 288: lightbits.api.duros.v2.DurosAPI.EnableFeatureFlag:output_type -> lightbits.api.duros.v2.SetFeatureFlagResponse
	129, // 289: lightbits.api.duros.v2.DurosAPI.DisableFeatureFlag:output_type -> lightbits.api.duros.v2.SetFeatureFlagResponse
	131, // 290: lightbits.api.duros.v2.DurosAPI.ListFeatureFlags:output_type -> lightbits.api.duros.v2.ListFeatureFlagsResponse
	151, // 291: lightbits.api.duros.v2.DurosAPI.GetClusterConfigParam:output_type -> lightbits.api.duros.v2.ClusterConfigParam
	155, // 292: lightbits.api.duros.v2.DurosAPI.UpdateClusterConfigParam:output_type -> lightbits.api.duros.v2.UpdateClusterConfigParamResponse
	157, // 293: lightbits.api.duros.v2.DurosAPI.ListClusterConfigParams:output_type -> lightbits.api.duros.v2.ListClusterConfigParamsResponse
	154, // 294: lightbits.api.duros.v2.DurosAPI.RollbackVolume:output_type -> lightbits.api.duros.v2.RollbackVolumeResponse
	170, // 295: lightbits.api.duros.v2.DurosAPI.ListChangedBlocks:output_type -> lightbits.api.duros.v2.ListChangedBlocksResponse
	178, // 296: lightbits.api.duros.v2.DurosAPI.RotateClusterRootKey:output_type -> lightbits.api.duros.v2.RotateClusterRootKeyResponse
	180, // 297: lightbits.api.duros.v2.DurosAPI.GetClusterRootKey:output_type -> lightbits.api.duros.v2.GetClusterRootKeyResponse
	181, // 298: lightbits.api.duros.v2.DurosAPI.CreateIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	188, // 299: lightbits.api.duros.v2.DurosAPI.DeleteIdpConfiguration:output_type -> lightbits.api.duros.v2.DeleteIDPConfigurationResponse
	181, // 300: lightbits.api.duros.v2.DurosAPI.UpdateIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	185, // 301: lightbits.api.duros.v2.DurosAPI.ListIdpConfigurations:output_type -> lightbits.api.duros.v2.ListIDPConfigurationsResponse
	181, // 302: lightbits.api.duros.v2.DurosAPI.GetIdpConfiguration:output_type -> lightbits.api.duros.v2.IDPConfiguration
	189, // 303: lightbits.api.duros.v2.DurosAPI.CreateIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	...
	196, // 306: lightbits.api.duros.v2.DurosAPI.ListIdpClientConfs:output_type -> lightbits.api.duros.v2.ListIdpClientConfsResponse
	189, // 307: lightbits.api.duros.v2.DurosAPI.GetIdpClientConf:output_type -> lightbits.api.duros.v2.IdpClientConf
	197, // 308: lightbits.api.duros.v2.DurosAPI.CreateAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	197, // 309: lightbits.api.duros.v2.DurosAPI.UpdateAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	203, // 310: lightbits.api.duros.v2.DurosAPI.DeleteAuthMapEntry:output_type -> lightbits.api.duros.v2.DeleteAuthMapEntryResponse
	197, // 311: lightbits.api.duros.v2.DurosAPI.GetAuthMapEntry:output_type -> lightbits.api.duros.v2.AuthMapEntry
	204, // 312: lightbits.api.duros.v2.DurosAPI.ListAuthMapEntries:output_type -> lightbits.api.duros.v2.ListAuthMapEntriesResponse
	232, // 313: lightbits.api.duros.v2.DurosAPI.EnableClusterInBandAuth:output_type -> lightbits.api.duros.v2.EnableClusterInBandAuthResponse
	233, // 314: lightbits.api.duros.v2.DurosAPI.DisableClusterInBandAuth:output_type -> lightbits.api.duros.v2.DisableClusterInBandAuthResponse
	234, // 315: lightbits.api.duros.v2.DurosAPI.CreateTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	235, // 316: lightbits.api.duros.v2.DurosAPI.DeleteTrustedHost:output_type -> lightbits.api.duros.v2.DeleteTrustedHostResponse
	234, // 317: lightbits.api.duros.v2.DurosAPI.GetTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	236, // 318: lightbits.api.duros.v2.DurosAPI.ListTrustedHosts:output_type -> lightbits.api.duros.v2.ListTrustedHostsResponse
	234, // 319: lightbits.api.duros.v2.DurosAPI.UpdateTrustedHost:output_type -> lightbits.api.duros.v2.TrustedHost
	237, // 320: lightbits.api.duros.v2.DurosAPI.SetTrustedHostSecret:output_type -> lightbits.api.duros.v2.SetTrustedHostSecretsResponse
	238, // 321: lightbits.api.duros.v2.DurosAPI.GetTrustedHostSecret:output_type -> lightbits.api.duros.v2.GetTrustedHostSecretsResponse
	229, // [229:322] is the sub-list for method output_type
	136, // [136:229] is the sub-list for method input_type
